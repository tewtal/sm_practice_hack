...
- Added No X-Factor variations for PRKD's Lower Norfair presets. (2.2.9)
- Allow users to save and load custom presets from SRAM. (2.2.9)
- Added 100% Map Completion category presets. (2.2.9)
