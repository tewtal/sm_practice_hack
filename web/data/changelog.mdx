...
- Add support for showing an overlay of Samus hitbox on top of Samus sprite (2.2.9)
- Added a "OOB Tile Viewer" that will show an overlay of raw tile data on top of the screen, useful for OOB navigation (2.2.9)
