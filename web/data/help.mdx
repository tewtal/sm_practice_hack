...
| - Custom Preset Slot          | Select one of 40 slots in memory to save or load custom presets. Press A to open a submenu with a list of preset slots. Press Y in the submenu to toggle the display between room names and Samus data.
