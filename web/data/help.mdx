...
| - Reload Last Preset          | Reload the last selected category preset
...
| - Custom Door Portal          | Sets one pair of doors connected to each other as you might see in an area or boss randomizer
| - Next Door Jump To Dest      | Temporarily sets the destination of the next door or elevator that you enter
| - Select Portal Source        | Choose one of of the two portal connections (8 boss portals and 32 area portals supported)
