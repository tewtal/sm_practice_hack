...
It only works in WRITG. The number is the most amount of frames you can take to wiggle, with larger numbers indicating your jump was closer to the optimal YH position.
