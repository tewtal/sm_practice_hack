...
Provides feedback on attempts to manipulate Mother Brain into a fast sitdown animation (after just two cries) while performing the standup glitch.
This assumes you are using the method starting from angle-crouch jump, aim down while at or above Mother Brain's head, morph into an automatic springball jump, and unmorph while falling.
&nbsp;  
...
- Y# indicates you jumped on one of the six good frames (although Y2 is not ideal).
- L# indicates you jumped late where the number tells you how many frames you were late.
...
- X# indicates you unmorphed on one of the six good frames, but because your first jump happened on YE or Y2, the manip will not work.
- Y# indicates you unmorphed on one of the six good frames and were not scammed by YE or Y2.
