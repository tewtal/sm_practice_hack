...
mkdir src\generated
python names\create_names.py ..\src\generated\roomnames.asm default_names.txt custom_names.txt
cd resources
...
copy *.sfc ..\build
..\tools\asar --no-title-check -DFEATURE_SD2SNES=0 -DFEATURE_PAL=1 -DFEATURE_TINYSTATES=1 ..\src\main.asm ..\build\00.sfc
