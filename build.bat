...
cp resources/sm_orig.sfc build/smhack20_gtclassic.sfc && cd src && ..\tools\asar --no-title-check -DFEATURE_SD2SNES=0 -DCATEGORY=3 main.asm ../build/smhack20_kpdr25.sfc && cd ..
