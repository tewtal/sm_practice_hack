...
python3 sort_debug_symbols.py ../build/Debugging_Symbols.sym ../build/Debugging_Sorted.sym
python3 create_ips.py ../build/00.sfc ../build/ff.sfc ../build/smhack20_sd2snes_dev.ips
