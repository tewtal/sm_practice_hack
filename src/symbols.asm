...
ram_activated_shine_duration = !ram_activated_shine_duration ; !WRAM_START+$34
...
ram_xpos = !ram_xpos ; !WRAM_START+$8E
ram_ypos = !ram_ypos ; !WRAM_START+$90
ram_subpixel_pos = !ram_subpixel_pos ; !WRAM_START+$92
ram_HUD_check = !ram_HUD_check ; !WRAM_START+$94
ram_shot_timer = !ram_shot_timer ; !WRAM_START+$96
ram_quickdrop_counter = !ram_quickdrop_counter ; !WRAM_START+$98
ram_walljump_counter = !ram_walljump_counter ; !WRAM_START+$9A
ram_fail_sum = !ram_fail_sum ; !WRAM_START+$9C
ram_fail_count = !ram_fail_count ; !WRAM_START+$9E

; Shot timer also reuses values
ram_shot_timer_past1 = !ram_shot_timer_past1 ; !WRAM_START+$98
ram_shot_timer_past2 = !ram_shot_timer_past2 ; !WRAM_START+$9A
ram_shot_timer_past3 = !ram_shot_timer_past3 ; !WRAM_START+$9C
ram_shot_timer_past4 = !ram_shot_timer_past4 ; !WRAM_START+$9E

; Kihunter manip
ram_enemy0_last_xpos = !ram_enemy0_last_xpos ; !WRAM_START+$8E
ram_enemy0_last_ypos = !ram_enemy0_last_ypos ; !WRAM_START+$90
ram_enemy4_last_xpos = !ram_enemy4_last_xpos ; !WRAM_START+$92
ram_enemy4_last_ypos = !ram_enemy4_last_ypos ; !WRAM_START+$94
ram_enemy6_last_xpos = !ram_enemy6_last_xpos ; !WRAM_START+$96
ram_enemy6_last_ypos = !ram_enemy6_last_ypos ; !WRAM_START+$98
ram_enemy8_last_xpos = !ram_enemy8_last_xpos ; !WRAM_START+$9A
ram_enemy8_last_ypos = !ram_enemy8_last_ypos ; !WRAM_START+$9C

; Kraid radar (reuses above ram_enemy6 variables)
ram_radar6 = !ram_radar6 ; !WRAM_START+$8E
ram_radar7 = !ram_radar7 ; !WRAM_START+$90
ram_enemy7_last_xpos = !ram_enemy7_last_xpos ; !WRAM_START+$9A
ram_enemy7_last_ypos = !ram_enemy7_last_ypos ; !WRAM_START+$9C

; Shinetune
ram_shine_dash_held_late = !ram_shine_dash_held_late ; !WRAM_START+$8E
ram_shinetune_early_1 = !ram_shinetune_early_1 ; !WRAM_START+$90
ram_shinetune_late_1 = !ram_shinetune_late_1 ; !WRAM_START+$92
ram_shinetune_early_2 = !ram_shinetune_early_2 ; !WRAM_START+$94
ram_shinetune_late_2 = !ram_shinetune_late_2 ; !WRAM_START+$96
ram_shinetune_early_3 = !ram_shinetune_early_3 ; !WRAM_START+$98
ram_shinetune_late_3 = !ram_shinetune_late_3 ; !WRAM_START+$9A
ram_shinetune_early_4 = !ram_shinetune_early_4 ; !WRAM_START+$9C
ram_shinetune_late_4 = !ram_shinetune_late_4 ; !WRAM_START+$9E
...
ram_game_loop_extras = !ram_game_loop_extras ; !WRAM_PERSIST_START+$0E
ram_infinite_ammo = !ram_infinite_ammo ; !WRAM_PERSIST_START+$10
ram_suits_heat_damage_value = !ram_suits_heat_damage_value ; !WRAM_PERSIST_START+$12
ram_sprite_feature_flags = !ram_sprite_feature_flags ; !WRAM_PERSIST_START+$14
ram_door_portal_flags = !ram_door_portal_flags ; !WRAM_PERSIST_START+$16
ram_door_source = !ram_door_source ; !WRAM_PERSIST_START+$18
ram_door_destination = !ram_door_destination ; !WRAM_PERSIST_START+$1A
ram_frames_held = !ram_frames_held ; !WRAM_PERSIST_START+$1C
...
ram_auto_save_state = !ram_auto_save_state ; !WRAM_PERSIST_START+$24
ram_last_save_state_type = !ram_last_save_state_type ; !WRAM_PERSIST_START+$26
...
ram_update_timers_flag = !ram_update_timers_flag ; !WRAM_PERSIST_START+$4E
...
ram_cm_drop_chances = !ram_cm_drop_chances ; !WRAM_MENU_START+$92
...
ram_cm_botwoon_first_rng = !ram_cm_botwoon_first_rng ; !WRAM_MENU_START+$9C
ram_cm_botwoon_hidden_rng = !ram_cm_botwoon_hidden_rng ; !WRAM_MENU_START+$9E
ram_cm_botwoon_second_rng = !ram_cm_botwoon_second_rng ; !WRAM_MENU_START+$A0
ram_cm_botwoon_spit_rng = !ram_cm_botwoon_spit_rng ; !WRAM_MENU_START+$A2
ram_cm_botwoon_after_spit_rng = !ram_cm_botwoon_after_spit_rng ; !WRAM_MENU_START+$A4
...
sram_hard_reset_clears_rng = !sram_hard_reset_clears_rng ; !SRAM_START+$D1 ; only uses first bit
sram_kraid_claw_rng = !sram_kraid_claw_rng ; !SRAM_START+$D2
sram_kraid_wait_rng = !sram_kraid_wait_rng ; !SRAM_START+$D4
sram_draygon_rng_left = !sram_draygon_rng_left ; !SRAM_START+$D6
sram_draygon_rng_right = !sram_draygon_rng_right ; !SRAM_START+$D8
sram_turret_rng = !sram_turret_rng ; !SRAM_START+$DA
sram_ridley_rng_flags = !sram_ridley_rng_flags ; !SRAM_START+$DC
sram_ridley_rng_times_and_fireball = !sram_ridley_rng_times_and_fireball ; !SRAM_START+$DE
sram_crocomire_rng = !sram_crocomire_rng ; !SRAM_START+$E0
sram_phantoon_phase_rng = !sram_phantoon_phase_rng ; !SRAM_START+$E2
sram_phantoon_eye_and_flames_rng = !sram_phantoon_eye_and_flames_rng ; !SRAM_START+$E4
sram_botwoon_rng = !sram_botwoon_rng ; !SRAM_START+$E6
sram_baby_rng = !sram_baby_rng ; !SRAM_START+$E8
sram_mb_rng = !sram_mb_rng ; !SRAM_START+$EA
sram_rng_reserved = !sram_rng_reserved ; !SRAM_START+$EC ; available
