...
preset_rbo_brinstar_cleanup_red_tower_up:
...
preset_rbo_brinstar_cleanup_green_brinstar_backdoor:
    dw #preset_rbo_brinstar_cleanup_red_tower_up ; Brinstar Cleanup: Red Tower (Up)
...
preset_rbo_norfair_escape_3_muskateers_exit:
...
preset_rbo_norfair_escape_croc_gate_farm:
    dw #preset_rbo_norfair_escape_3_muskateers_exit ; Norfair Escape: 3 Muskateers Exit
...
preset_rbo_kraidg4_red_tower_up_2:
...
preset_rbo_kraidg4_crateria_kihunters_room_up:
    dw #preset_rbo_kraidg4_red_tower_up_2 ; Kraid/G4: Red Tower (Up)
