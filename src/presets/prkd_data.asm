...
preset_prkd_crateria_ceres_escape:
...
preset_prkd_crateria_ceres_last_3_rooms:
    dw #preset_prkd_crateria_ceres_escape ; Crateria: Ceres Escape
    dw $078D, $ABA0  ; DDB
    dw $079B, $E021  ; MDB
...
preset_prkd_red_brinstar_revisit_caterpillars_revisit:
...
preset_prkd_red_brinstar_revisit_hellway_revisit:
    dw #preset_prkd_red_brinstar_revisit_caterpillars_revisit ; Red Brinstar Revisit: Caterpillars Revisit
...
preset_prkd_upper_norfair_hi_jump_etank:
    dw #preset_prkd_upper_norfair_business_center_postelev ; Upper Norfair: Business Center Post-Elev
...
preset_prkd_tourian_mother_brain_2:
...
preset_prkd_tourian_mother_brain_3:
    dw #preset_prkd_tourian_mother_brain_2 ; Tourian: Mother Brain 2
...
preset_prkd_tourian_escape_climb:
    dw #preset_prkd_tourian_escape_room_4 ; Tourian: Escape Room 4
    dw $078D, $AB1C  ; DDB
    dw $079B, $DEDE  ; MDB
    dw $090F, $0000  ; Screen subpixel X position
...
preset_prkd_tourian_escape_parlor:
    dw #preset_prkd_tourian_escape_climb ; Tourian: Escape Climb
    dw $078D, $AB34  ; DDB
    dw $079B, $96BA  ; MDB
    dw $090F, $8FFF  ; Screen subpixel X position
    dw $0911, $0100  ; Screen X position in pixels
