...
preset_kpdr22_crateria_ceres_escape:
    dw #preset_kpdr22_crateria_ceres_elevator ; Crateria: Ceres Elevator
    dw $078D, $ABAC  ; DDB
    dw $079B, $E0B5  ; MDB
...
preset_kpdr22_crateria_ceres_last_3_rooms:
    dw #preset_kpdr22_crateria_ceres_escape ; Crateria: Ceres Escape
    dw $078D, $ABA0  ; DDB
    dw $079B, $E021  ; MDB
...
preset_kpdr22_crateria_ship:
    dw #preset_kpdr22_crateria_ceres_last_3_rooms ; Crateria: Ceres Last 3 Rooms
    dw $078D, $88FE  ; DDB
    dw $079B, $91F8  ; MDB
...
preset_kpdr22_crateria_climb_down:
    dw #preset_kpdr22_crateria_parlor_downback ; Crateria: Parlor Downback
...
preset_kpdr22_crateria_pit_room:
    dw #preset_kpdr22_crateria_climb_down ; Crateria: Climb Down
    dw $078D, $898E  ; DDB
    dw $079B, $96BA  ; MDB
...
preset_kpdr22_crateria_morph:
    dw #preset_kpdr22_crateria_pit_room ; Crateria: Pit Room
    dw $078D, $8B9E  ; DDB
    dw $079B, $9E9F  ; MDB
    dw $07F5, $0007  ; Music Track
...
preset_kpdr22_crateria_construction_zone:
    dw #preset_kpdr22_crateria_morph ; Crateria: Morph
...
preset_kpdr22_crateria_construction_zone_revisit:
    dw #preset_kpdr22_crateria_construction_zone ; Crateria: Construction Zone
    dw $078D, $8EDA  ; DDB
    dw $079B, $A107  ; MDB
...
preset_kpdr22_crateria_pit_room_revisit:
    dw #preset_kpdr22_crateria_construction_zone_revisit ; Crateria: Construction Zone Revisit
    dw $078D, $8EB6  ; DDB
    dw $079B, $97B5  ; MDB
...
preset_kpdr22_crateria_climb_up:
    dw #preset_kpdr22_crateria_pit_room_revisit ; Crateria: Pit Room Revisit
    dw $078D, $8B92  ; DDB
    dw $079B, $975C  ; MDB
...
preset_kpdr22_crateria_parlor_revisit:
    dw #preset_kpdr22_crateria_climb_up ; Crateria: Climb Up
    dw $078D, $8B7A  ; DDB
    dw $079B, $96BA  ; MDB
    dw $090F, $0000  ; Screen subpixel X position
    dw $0911, $0100  ; Screen X position in pixels
...
preset_kpdr22_crateria_flyway:
    dw #preset_kpdr22_crateria_parlor_revisit ; Crateria: Parlor Revisit
    dw $078D, $8B3E  ; DDB
    dw $079B, $92FD  ; MDB
...
preset_kpdr22_crateria_bomb_torizo:
    dw #preset_kpdr22_crateria_flyway ; Crateria: Flyway
    dw $078D, $8982  ; DDB
    dw $079B, $9879  ; MDB
    dw $090F, $4000  ; Screen subpixel X position
...
preset_kpdr22_crateria_alcatraz:
    dw #preset_kpdr22_crateria_bomb_torizo ; Crateria: Bomb Torizo
    dw $078D, $8BAA  ; DDB
...
preset_kpdr22_crateria_terminator:
    dw #preset_kpdr22_crateria_alcatraz ; Crateria: Alcatraz
    dw $078D, $8BB6  ; DDB
    dw $079B, $92FD  ; MDB
    dw $090F, $6000  ; Screen subpixel X position
    dw $0911, $0100  ; Screen X position in pixels
...
preset_kpdr22_crateria_green_pirate_shaft:
    dw #preset_kpdr22_crateria_terminator ; Crateria: Terminator
    dw $078D, $895E  ; DDB
    dw $079B, $990D  ; MDB
...
preset_kpdr22_brinstar_green_brinstar_elevator:
    dw #preset_kpdr22_crateria_green_pirate_shaft ; Crateria: Green Pirate Shaft
    dw $078D, $8C22  ; DDB
    dw $079B, $9938  ; MDB
    dw $07F5, $0003  ; Music Track
    dw $090F, $8000  ; Screen subpixel X position
...
preset_kpdr22_brinstar_early_supers:
    dw #preset_kpdr22_brinstar_green_brinstar_elevator ; Brinstar: Green Brinstar Elevator
    dw $078D, $8C0A  ; DDB
    dw $079B, $9AD9  ; MDB
...
preset_kpdr22_brinstar_dachora_room:
    dw #preset_kpdr22_brinstar_early_supers ; Brinstar: Early Supers
    dw $078D, $8D4E  ; DDB
...
preset_kpdr22_brinstar_big_pink:
    dw #preset_kpdr22_brinstar_dachora_room ; Brinstar: Dachora Room
    dw $078D, $8CE2  ; DDB
    dw $079B, $9CB3  ; MDB
...
preset_kpdr22_brinstar_green_hill_zone:
    dw #preset_kpdr22_brinstar_big_pink ; Brinstar: Big Pink
    dw $078D, $8DAE  ; DDB
    dw $079B, $9D19  ; MDB
    dw $090F, $8000  ; Screen subpixel X position
    dw $0911, $0300  ; Screen X position in pixels
...
preset_kpdr22_brinstar_noob_bridge:
    dw #preset_kpdr22_brinstar_green_hill_zone ; Brinstar: Green Hill Zone
    dw $078D, $8DEA  ; DDB
    dw $079B, $9E52  ; MDB
    dw $090F, $0000  ; Screen subpixel X position
    dw $0911, $0700  ; Screen X position in pixels
...
preset_kpdr22_brinstar_red_tower:
    dw #preset_kpdr22_brinstar_noob_bridge ; Brinstar: Noob Bridge
    dw $078D, $8E92  ; DDB
    dw $079B, $9FBA  ; MDB
...
preset_kpdr22_brinstar_skree_boost:
    dw #preset_kpdr22_brinstar_red_tower ; Brinstar: Red Tower
    dw $078D, $8F0A  ; DDB
    dw $079B, $A253  ; MDB
...
preset_kpdr22_brinstar_below_spazer:
    dw #preset_kpdr22_brinstar_skree_boost ; Brinstar: Skree Boost
    dw $078D, $9042  ; DDB
    dw $079B, $A3DD  ; MDB
...
preset_kpdr22_brinstar_passing_through_maridia:
    dw #preset_kpdr22_brinstar_below_spazer ; Brinstar: Below Spazer
    dw $078D, $9132  ; DDB
    dw $079B, $A408  ; MDB
    dw $090F, $8000  ; Screen subpixel X position
    dw $0911, $0100  ; Screen X position in pixels
...
preset_kpdr22_kraid_entering_kraids_lair:
    dw #preset_kpdr22_brinstar_passing_through_maridia ; Brinstar: Passing Through Maridia
    dw $078D, $A348  ; DDB
    dw $079B, $CF80  ; MDB
    dw $090F, $4000  ; Screen subpixel X position
    dw $0911, $0000  ; Screen X position in pixels
...
preset_kpdr22_kraid_kraid:
    dw #preset_kpdr22_kraid_fallen_hero ; Kraid: Fallen Hero
    dw $078D, $919E  ; DDB
    dw $079B, $A56B  ; MDB
...
preset_kpdr22_kraid_leaving_varia:
    dw #preset_kpdr22_kraid_kraid ; Kraid: Kraid
    dw $078D, $91DA  ; DDB
    dw $079B, $A6E2  ; MDB
    dw $07F5, $0003  ; Music Track
...
preset_kpdr22_kraid_arthur_j_metroid:
    dw #preset_kpdr22_kraid_leaving_varia ; Kraid: Leaving Varia
    dw $078D, $9252  ; DDB
    dw $079B, $A59F  ; MDB
...
preset_kpdr22_kraid_kraid_etank:
    dw #preset_kpdr22_kraid_kraid_kihunters_revisit ; Kraid: Kraid Kihunters Revisit
    dw $078D, $916E  ; DDB
    dw $079B, $A471  ; MDB
    dw $07F3, $0012  ; Music Bank
    dw $07F5, $0005  ; Music Track
...
preset_kpdr22_kraid_leaving_kraid_etank:
    dw #preset_kpdr22_kraid_kraid_etank ; Kraid: Kraid E-Tank
    dw $078D, $914A  ; DDB
    dw $079B, $A4B1  ; MDB
    dw $090F, $2000  ; Screen subpixel X position
...
preset_kpdr22_kraid_business_center_preelev:
    dw #preset_kpdr22_kraid_leaving_kraid_etank ; Kraid: Leaving Kraid E-Tank
    dw $078D, $913E  ; DDB
    dw $079B, $A6A1  ; MDB
    dw $07F5, $0003  ; Music Track
    dw $090F, $3000  ; Screen subpixel X position
...
preset_kpdr22_upper_norfair_leaving_hijump:
    dw #preset_kpdr22_upper_norfair_hijump_etank ; Upper Norfair: Hi-Jump E-Tank
    dw $078D, $9426  ; DDB
    dw $079B, $A9E5  ; MDB
    dw $07F5, $0003  ; Music Track
...
preset_kpdr22_upper_norfair_business_center_revisit:
    dw #preset_kpdr22_upper_norfair_leaving_hijump ; Upper Norfair: Leaving Hi-Jump
    dw $078D, $93F6  ; DDB
    dw $079B, $AA41  ; MDB
    dw $07F5, $0005  ; Music Track
    dw $090F, $4000  ; Screen subpixel X position
...
preset_kpdr22_wrecked_ship_ocean_spark:
    dw #preset_kpdr22_wrecked_ship_ocean_fly_setup ; Wrecked Ship: Ocean Fly Setup
    dw $078D, $8A36  ; DDB
    dw $079B, $95FF  ; MDB
...
preset_kpdr22_wrecked_ship_phantoon:
    dw #preset_kpdr22_wrecked_ship_basement ; Wrecked Ship: Basement
    dw $078D, $A21C  ; DDB
    dw $079B, $CC6F  ; MDB
    dw $090F, $F000  ; Screen subpixel X position
...
preset_kpdr22_wrecked_ship_leaving_phantoon:
    dw #preset_kpdr22_wrecked_ship_phantoon ; Wrecked Ship: Phantoon
    dw $078D, $A2AC  ; DDB
    dw $079B, $CD13  ; MDB
    dw $07F5, $0003  ; Music Track
    dw $090F, $6000  ; Screen subpixel X position
...
preset_kpdr22_wrecked_ship_shaft_to_supers:
    dw #preset_kpdr22_wrecked_ship_leaving_phantoon ; Wrecked Ship: Leaving Phantoon
    dw $078D, $A2C4  ; DDB
    dw $079B, $CC6F  ; MDB
    dw $07F5, $0006  ; Music Track
    dw $090F, $8000  ; Screen subpixel X position
...
preset_kpdr22_wrecked_ship_wrecked_ship_shaft:
    dw #preset_kpdr22_wrecked_ship_shaft_to_supers ; Wrecked Ship: Shaft To Supers
    dw $078D, $A210  ; DDB
    dw $079B, $CDA8  ; MDB
    dw $090F, $3000  ; Screen subpixel X position
    dw $0911, $0000  ; Screen X position in pixels
...
preset_kpdr22_wrecked_ship_attic:
    dw #preset_kpdr22_wrecked_ship_wrecked_ship_shaft ; Wrecked Ship: Wrecked Ship Shaft
    dw $078D, $A2E8  ; DDB
    dw $079B, $CAF6  ; MDB
...
preset_kpdr22_wrecked_ship_upper_west_ocean:
    dw #preset_kpdr22_wrecked_ship_attic ; Wrecked Ship: Attic
    dw $078D, $A228  ; DDB
    dw $079B, $CA52  ; MDB
    dw $090F, $7000  ; Screen subpixel X position
    dw $0911, $0000  ; Screen X position in pixels
...
preset_kpdr22_wrecked_ship_pancakes_and_wavers:
    dw #preset_kpdr22_wrecked_ship_upper_west_ocean ; Wrecked Ship: Upper West Ocean
    dw $078D, $A1E0  ; DDB
    dw $079B, $93FE  ; MDB
    dw $07F3, $000C  ; Music Bank
    dw $07F5, $0005  ; Music Track
...
preset_kpdr22_wrecked_ship_bowling_spark:
    dw #preset_kpdr22_wrecked_ship_pancakes_and_wavers ; Wrecked Ship: Pancakes and Wavers
    dw $078D, $89E2  ; DDB
    dw $079B, $9461  ; MDB
...
preset_kpdr22_wrecked_ship_leaving_gravity:
    dw #preset_kpdr22_wrecked_ship_bowling_spark ; Wrecked Ship: Bowling Spark
    dw $078D, $A1A4  ; DDB
    dw $079B, $CE40  ; MDB
    dw $07F3, $0030  ; Music Bank
    dw $07F5, $0003  ; Music Track
...
preset_kpdr22_wrecked_ship_moat_ball:
    dw #preset_kpdr22_wrecked_ship_leaving_gravity ; Wrecked Ship: Leaving Gravity
    dw $078D, $A300  ; DDB
    dw $079B, $93FE  ; MDB
    dw $07F3, $000C  ; Music Bank
    dw $07F5, $0005  ; Music Track
...
preset_kpdr22_red_brinstar_revisit_caterpillars_revisit:
    dw #preset_kpdr22_red_brinstar_revisit_red_brinstar_elevator ; Red Brinstar Revisit: Red Brinstar Elevator
    dw $078D, $8B02  ; DDB
    dw $079B, $A322  ; MDB
    dw $07F3, $0012  ; Music Bank
    dw $07F5, $0005  ; Music Track
...
preset_kpdr22_red_brinstar_revisit_hellway_revisit:
    dw #preset_kpdr22_red_brinstar_revisit_caterpillars_revisit ; Red Brinstar Revisit: Caterpillars Revisit
    dw $090F, $C000  ; Screen subpixel X position
    dw $0913, $2800  ; Screen subpixel Y position
...
preset_kpdr22_red_brinstar_revisit_red_tower_down:
    dw #preset_kpdr22_red_brinstar_revisit_hellway_revisit ; Red Brinstar Revisit: Hellway Revisit
    dw $078D, $90AE  ; DDB
    dw $079B, $A2F7  ; MDB
...
preset_kpdr22_red_brinstar_revisit_skree_boost_final:
    dw #preset_kpdr22_red_brinstar_revisit_red_tower_down ; Red Brinstar Revisit: Red Tower Down
    dw $078D, $907E  ; DDB
    dw $079B, $A253  ; MDB
...
preset_kpdr22_red_brinstar_revisit_below_spazer_final:
    dw #preset_kpdr22_red_brinstar_revisit_skree_boost_final ; Red Brinstar Revisit: Skree Boost Final
    dw $078D, $9042  ; DDB
    dw $079B, $A3DD  ; MDB
...
preset_kpdr22_maridia_mt_everest:
    dw #preset_kpdr22_maridia_fish_tank ; Maridia: Fish Tank
    dw $078D, $A3F0  ; DDB
    dw $079B, $D0B9  ; MDB
    dw $090F, $8000  ; Screen subpixel X position
    dw $0911, $0100  ; Screen X position in pixels
...
preset_kpdr22_maridia_crab_shaft:
    dw #preset_kpdr22_maridia_mt_everest ; Maridia: Mt. Everest
    dw $090F, $E000  ; Screen subpixel X position
    dw $0911, $0500  ; Screen X position in pixels
...
preset_kpdr22_maridia_aqueduct:
    dw #preset_kpdr22_maridia_crab_shaft ; Maridia: Crab Shaft
    dw $078D, $A468  ; DDB
    dw $079B, $D1A3  ; MDB
    dw $090F, $0000  ; Screen subpixel X position
    dw $0911, $0100  ; Screen X position in pixels
...
preset_kpdr22_maridia_botwoon_hallway:
    dw #preset_kpdr22_maridia_aqueduct ; Maridia: Aqueduct
    dw $078D, $A4C8  ; DDB
    dw $079B, $D5A7  ; MDB
    dw $07F5, $0005  ; Music Track
    dw $090F, $A000  ; Screen subpixel X position
...
preset_kpdr22_maridia_botwoon:
    dw #preset_kpdr22_maridia_botwoon_hallway ; Maridia: Botwoon Hallway
    dw $078D, $A72C  ; DDB
    dw $079B, $D617  ; MDB
...
preset_kpdr22_maridia_botwoon_etank:
    dw #preset_kpdr22_maridia_botwoon ; Maridia: Botwoon
    dw $078D, $A774  ; DDB
    dw $079B, $D95E  ; MDB
...
preset_kpdr22_maridia_halfie_setup:
    dw #preset_kpdr22_maridia_botwoon_etank ; Maridia: Botwoon E-Tank
    dw $078D, $A918  ; DDB
    dw $079B, $D7E4  ; MDB
    dw $07F3, $001B  ; Music Bank
    dw $07F5, $0005  ; Music Track
...
preset_kpdr22_maridia_draygon:
    dw #preset_kpdr22_maridia_halfie_setup ; Maridia: Halfie Setup
    dw $078D, $A7F8  ; DDB
    dw $079B, $D78F  ; MDB
    dw $090F, $3000  ; Screen subpixel X position
    dw $0913, $E400  ; Screen subpixel Y position
...
preset_kpdr22_maridia_reverse_halfie_spikesuit:
    dw #preset_kpdr22_maridia_draygon ; Maridia: Draygon
    dw $078D, $A96C  ; DDB
    dw $090F, $6000  ; Screen subpixel X position
    dw $0913, $0000  ; Screen subpixel Y position
    dw $0915, $0000  ; Screen Y position in pixels
...
preset_kpdr22_maridia_whomple_jump:
    dw #preset_kpdr22_maridia_reverse_halfie_spikesuit ; Maridia: Reverse Halfie (Spikesuit)
    dw $0A68, $0000  ; Flash suit
    dw #$FFFF

preset_kpdr22_maridia_cac_alley_east:
    dw #preset_kpdr22_maridia_whomple_jump ; Maridia: Whomple Jump
    dw $078D, $A7E0  ; DDB
    dw $079B, $D913  ; MDB
    dw $090F, $8000  ; Screen subpixel X position
...
preset_kpdr22_maridia_cac_alley_west:
    dw #preset_kpdr22_maridia_cac_alley_east ; Maridia: Cac Alley East
    dw $078D, $A900  ; DDB
    dw $079B, $DA2B  ; MDB
    dw $090F, $B000  ; Screen subpixel X position
    dw $0915, $0002  ; Screen Y position in pixels
...
preset_kpdr22_maridia_plasma_spark:
    dw #preset_kpdr22_maridia_cac_alley_west ; Maridia: Cac Alley West
    dw $078D, $A93C  ; DDB
    dw $079B, $D5EC  ; MDB
    dw $090F, $2000  ; Screen subpixel X position
...
preset_kpdr22_maridia_plasma_climb:
    dw #preset_kpdr22_maridia_plasma_spark ; Maridia: Plasma Spark
    dw $078D, $A750  ; DDB
    dw $079B, $D340  ; MDB
...
preset_kpdr22_maridia_plasma_beam:
    dw #preset_kpdr22_maridia_plasma_climb ; Maridia: Plasma Climb
    dw $078D, $A5DC  ; DDB
    dw $079B, $D27E  ; MDB
    dw $090F, $9000  ; Screen subpixel X position
    dw $0911, $0000  ; Screen X position in pixels
...
preset_kpdr22_maridia_plasma_spark_revisit:
    dw #preset_kpdr22_maridia_plasma_beam ; Maridia: Plasma Beam
    dw $078D, $A540  ; DDB
    dw $079B, $D387  ; MDB
    dw $090F, $8000  ; Screen subpixel X position
    dw $0913, $0000  ; Screen subpixel Y position
...
preset_kpdr22_maridia_toilet:
    dw #preset_kpdr22_maridia_plasma_spark_revisit ; Maridia: Plasma Spark Revisit
    dw $078D, $A5D0  ; DDB
    dw $079B, $D340  ; MDB
...
preset_kpdr22_maridia_sewers:
    dw #preset_kpdr22_maridia_toilet ; Maridia: Toilet
    dw $078D, $A600  ; DDB
    dw $079B, $D48E  ; MDB
    dw $090F, $0000  ; Screen subpixel X position
    dw $0911, $0000  ; Screen X position in pixels
...
preset_kpdr22_maridia_lower_maridia_gate:
    dw #preset_kpdr22_maridia_sewers ; Maridia: Sewers
    dw $078D, $A528  ; DDB
    dw $079B, $D21C  ; MDB
    dw $090F, $8000  ; Screen subpixel X position
...
preset_kpdr22_upper_norfair_revisit_ice_beam_gates:
    dw #preset_kpdr22_maridia_lower_maridia_gate ; Maridia: Lower Maridia Gate
    dw $078D, $9246  ; DDB
    dw $079B, $A7DE  ; MDB
    dw $07F3, $0015  ; Music Bank
    dw $090F, $8000  ; Screen subpixel X position
...
preset_kpdr22_upper_norfair_revisit_ice_maze_up:
    dw #preset_kpdr22_upper_norfair_revisit_ice_beam_gates ; Upper Norfair Revisit: Ice Beam Gates
    dw $078D, $931E  ; DDB
    dw $079B, $A75D  ; MDB
    dw $090F, $6000  ; Screen subpixel X position
    dw $0913, $E800  ; Screen subpixel Y position
...
preset_kpdr22_upper_norfair_revisit_ice_maze_down:
    dw #preset_kpdr22_upper_norfair_revisit_ice_maze_up ; Upper Norfair Revisit: Ice Maze Up
    dw $078D, $937E  ; DDB
    dw $079B, $A890  ; MDB
    dw $07F5, $0003  ; Music Track
    dw $090F, $5000  ; Screen subpixel X position
...
preset_kpdr22_upper_norfair_revisit_ice_escape:
    dw #preset_kpdr22_upper_norfair_revisit_ice_maze_down ; Upper Norfair Revisit: Ice Maze Down
    dw $078D, $935A  ; DDB
    dw $079B, $A8B9  ; MDB
    dw $07F5, $0005  ; Music Track
    dw $090F, $E000  ; Screen subpixel X position
...
preset_kpdr22_upper_norfair_revisit_purple_shaft_upper:
    dw #preset_kpdr22_upper_norfair_revisit_ice_escape ; Upper Norfair Revisit: Ice Escape
    dw $078D, $971A  ; DDB
    dw $079B, $ACB3  ; MDB
    dw $090F, $0000  ; Screen subpixel X position
    dw $0913, $E800  ; Screen subpixel Y position
...
preset_kpdr22_upper_norfair_revisit_magdollite_tunnel_upper:
    dw #preset_kpdr22_upper_norfair_revisit_purple_shaft_upper ; Upper Norfair Revisit: Purple Shaft (Upper)
    dw $078D, $9576  ; DDB
    dw $079B, $AEDF  ; MDB
...
preset_kpdr22_upper_norfair_revisit_kronic_boost_upper:
    dw #preset_kpdr22_upper_norfair_revisit_magdollite_tunnel_upper ; Upper Norfair Revisit: Magdollite Tunnel (Upper)
    dw $078D, $96BA  ; DDB
    dw $079B, $AEB4  ; MDB
    dw $090F, $8000  ; Screen subpixel X position
    dw $0911, $0200  ; Screen X position in pixels
...
preset_kpdr22_upper_norfair_revisit_kronic_boost_lower:
    dw #preset_kpdr22_upper_norfair_revisit_spiky_acid_snakes_lower ; Upper Norfair Revisit: Spiky Acid Snakes (Lower)
    dw $078D, $9792  ; DDB
    dw $079B, $AFFB  ; MDB
    dw $090F, $B000  ; Screen subpixel X position
    dw $0911, $0300  ; Screen X position in pixels
...
preset_kpdr22_lower_norfair_ln_main_hall:
    dw #preset_kpdr22_upper_norfair_revisit_kronic_boost_upper ; Upper Norfair Revisit: Kronic Boost (Upper)
    dw $078D, $96F6  ; DDB
    dw $079B, $B236  ; MDB
...
preset_kpdr22_lower_norfair_prepillars:
    dw #preset_kpdr22_lower_norfair_ln_main_hall ; Lower Norfair: LN Main Hall
    dw $090F, $9000  ; Screen subpixel X position
    dw $0911, $0700  ; Screen X position in pixels
    dw $0913, $E400  ; Screen subpixel Y position
    dw $0917, $0540  ; Layer 2 X position
...
preset_kpdr22_lower_norfair_worst_room_in_the_game:
    dw #preset_kpdr22_lower_norfair_fast_pillars_setup ; Lower Norfair: Fast Pillars Setup
    dw $078D, $9912  ; DDB
    dw $079B, $B457  ; MDB
...
preset_kpdr22_lower_norfair_kihunter_stairs_down:
    dw #preset_kpdr22_lower_norfair_amphitheatre ; Lower Norfair: Amphitheatre
    dw $078D, $997E  ; DDB
    dw $079B, $B4E5  ; MDB
    dw $090F, $0000  ; Screen subpixel X position
...
preset_kpdr22_lower_norfair_wasteland:
    dw #preset_kpdr22_lower_norfair_kihunter_stairs_down ; Lower Norfair: Kihunter Stairs Down
    dw $078D, $99A2  ; DDB
    dw $079B, $B585  ; MDB
    dw $090F, $8000  ; Screen subpixel X position
    dw $0911, $0200  ; Screen X position in pixels
...
preset_kpdr22_lower_norfair_metal_ninja_pirates:
    dw #preset_kpdr22_lower_norfair_wasteland ; Lower Norfair: Wasteland
    dw $078D, $99EA  ; DDB
    dw $079B, $B5D5  ; MDB
    dw $090F, $E000  ; Screen subpixel X position
    dw $0911, $0100  ; Screen X position in pixels
...
preset_kpdr22_lower_norfair_plowerhouse:
    dw #preset_kpdr22_lower_norfair_metal_ninja_pirates ; Lower Norfair: Metal Ninja Pirates
    dw $078D, $9A1A  ; DDB
    dw $079B, $B62B  ; MDB
    dw $090F, $7000  ; Screen subpixel X position
    dw $0911, $0000  ; Screen X position in pixels
...
preset_kpdr22_lower_norfair_ridley:
    dw #preset_kpdr22_lower_norfair_plowerhouse ; Lower Norfair: Plowerhouse
    dw $078D, $995A  ; DDB
    dw $079B, $B37A  ; MDB
    dw $090F, $2000  ; Screen subpixel X position
...
preset_kpdr22_lower_norfair_leaving_ridley:
    dw #preset_kpdr22_lower_norfair_ridley ; Lower Norfair: Ridley
    dw $078D, $98CA  ; DDB
    dw $079B, $B32E  ; MDB
    dw $07F3, $0024  ; Music Bank
    dw $07F5, $0003  ; Music Track
...
preset_kpdr22_lower_norfair_reverse_plowerhouse:
    dw #preset_kpdr22_lower_norfair_leaving_ridley ; Lower Norfair: Leaving Ridley
    dw $078D, $98BE  ; DDB
    dw $079B, $B37A  ; MDB
    dw $07F3, $0018  ; Music Bank
    dw $07F5, $0005  ; Music Track
...
preset_kpdr22_lower_norfair_wasteland_revisit:
    dw #preset_kpdr22_lower_norfair_reverse_plowerhouse ; Lower Norfair: Reverse Plowerhouse
    dw $078D, $9966  ; DDB
    dw $079B, $B62B  ; MDB
    dw $090F, $9000  ; Screen subpixel X position
    dw $0913, $7400  ; Screen subpixel Y position
...
preset_kpdr22_lower_norfair_kihunter_stairs_up:
    dw #preset_kpdr22_lower_norfair_wasteland_revisit ; Lower Norfair: Wasteland Revisit
    dw $078D, $9A3E  ; DDB
    dw $079B, $B5D5  ; MDB
...
preset_kpdr22_lower_norfair_three_musketeers:
    dw #preset_kpdr22_lower_norfair_springball_maze ; Lower Norfair: Springball Maze
    dw $078D, $9A92  ; DDB
    dw $079B, $B510  ; MDB
...
preset_kpdr22_lower_norfair_single_chamber_final:
    dw #preset_kpdr22_lower_norfair_three_musketeers ; Lower Norfair: Three Musketeers
    dw $078D, $99AE  ; DDB
    dw $079B, $B656  ; MDB
    dw $090F, $9000  ; Screen subpixel X position
    dw $0911, $0100  ; Screen X position in pixels
...
preset_kpdr22_lower_norfair_bubble_mountain_final:
    dw #preset_kpdr22_lower_norfair_single_chamber_final ; Lower Norfair: Single Chamber Final
    dw $078D, $9A4A  ; DDB
    dw $079B, $AD5E  ; MDB
    dw $07F3, $0015  ; Music Bank
    dw $090F, $8000  ; Screen subpixel X position
...
preset_kpdr22_lower_norfair_business_center_final:
    dw #preset_kpdr22_lower_norfair_bubble_mountain_final ; Lower Norfair: Bubble Mountain Final
    dw $078D, $97DA  ; DDB
    dw $079B, $B167  ; MDB
    dw $090F, $6000  ; Screen subpixel X position
    dw $0913, $5000  ; Screen subpixel Y position
...
preset_kpdr22_backtracking_maridia_tube_revisit:
    dw #preset_kpdr22_lower_norfair_business_center_final ; Lower Norfair: Business Center Final
    dw $078D, $92EE  ; DDB
    dw $079B, $A6A1  ; MDB
    dw $07F3, $0012  ; Music Bank
    dw $07F5, $0003  ; Music Track
...
preset_kpdr22_backtracking_fish_tank_revisit:
    dw #preset_kpdr22_backtracking_maridia_tube_revisit ; Backtracking: Maridia Tube Revisit
    dw $078D, $A330  ; DDB
    dw $079B, $CFC9  ; MDB
    dw $07F3, $001B  ; Music Bank
    dw $07F5, $0006  ; Music Track
...
preset_kpdr22_backtracking_mt_everest_revisit:
    dw #preset_kpdr22_backtracking_fish_tank_revisit ; Backtracking: Fish Tank Revisit
    dw $078D, $A3B4  ; DDB
    dw $079B, $D017  ; MDB
    dw $090F, $E000  ; Screen subpixel X position
...
preset_kpdr22_backtracking_red_brinstar_green_gate:
    dw #preset_kpdr22_backtracking_mt_everest_revisit ; Backtracking: Mt. Everest Revisit
    dw $078D, $A42C  ; DDB
    dw $079B, $D104  ; MDB
...
preset_kpdr22_backtracking_crateria_kihunters_final:
    dw #preset_kpdr22_backtracking_red_brinstar_green_gate ; Backtracking: Red Brinstar Green Gate
    dw $078D, $90BA  ; DDB
    dw $079B, $962A  ; MDB
    dw $07F3, $0012  ; Music Bank
    dw $07F5, $0003  ; Music Track
...
preset_kpdr22_backtracking_parlor_spacejump:
    dw #preset_kpdr22_backtracking_crateria_kihunters_final ; Backtracking: Crateria Kihunters Final
    dw $078D, $8AC6  ; DDB
    dw $079B, $91F8  ; MDB
    dw $07F3, $000C  ; Music Bank
    dw $07F5, $0005  ; Music Track
...
preset_kpdr22_backtracking_terminator_revisit:
    dw #preset_kpdr22_backtracking_parlor_spacejump ; Backtracking: Parlor Spacejump
    dw $078D, $8916  ; DDB
    dw $079B, $92FD  ; MDB
    dw $07F3, $0009  ; Music Bank
    dw $090F, $4000  ; Screen subpixel X position
...
preset_kpdr22_backtracking_green_pirate_shaft_revisit:
    dw #preset_kpdr22_backtracking_terminator_revisit ; Backtracking: Terminator Revisit
    dw $078D, $895E  ; DDB
    dw $079B, $990D  ; MDB
    dw $090F, $0000  ; Screen subpixel X position
    dw $0911, $0000  ; Screen X position in pixels
...
preset_kpdr22_backtracking_g4_hallway:
    dw #preset_kpdr22_backtracking_green_pirate_shaft_revisit ; Backtracking: Green Pirate Shaft Revisit
    dw $078D, $8BE6  ; DDB
    dw $079B, $99BD  ; MDB
    dw $090F, $F000  ; Screen subpixel X position
    dw $0913, $E400  ; Screen subpixel Y position
...
preset_kpdr22_backtracking_g4_elevator:
    dw #preset_kpdr22_backtracking_g4_hallway ; Backtracking: G4 Hallway
    dw $078D, $91F2  ; DDB
    dw $079B, $A66A  ; MDB
    dw $07F5, $0006  ; Music Track
    dw $090F, $7000  ; Screen subpixel X position
...
preset_kpdr22_tourian_tourian_elevator_room:
    dw #preset_kpdr22_backtracking_g4_elevator ; Backtracking: G4 Elevator
    dw $078D, $9222  ; DDB
    dw $079B, $DAAE  ; MDB
...
preset_kpdr22_tourian_metroids_1:
    dw #preset_kpdr22_tourian_tourian_elevator_room ; Tourian: Tourian Elevator Room
    dw $090F, $8000  ; Screen subpixel X position
...
preset_kpdr22_tourian_metroids_2:
    dw #preset_kpdr22_tourian_metroids_1 ; Tourian: Metroids 1
    dw $078D, $A984  ; DDB
    dw $079B, $DAE1  ; MDB
    dw $090F, $7000  ; Screen subpixel X position
    dw $0913, $5000  ; Screen subpixel Y position
...
preset_kpdr22_tourian_metroids_3:
    dw #preset_kpdr22_tourian_metroids_2 ; Tourian: Metroids 2
    dw $078D, $A9B4  ; DDB
    dw $079B, $DB31  ; MDB
    dw $090F, $9000  ; Screen subpixel X position
...
preset_kpdr22_tourian_metroids_4:
    dw #preset_kpdr22_tourian_metroids_3 ; Tourian: Metroids 3
    dw $078D, $A9CC  ; DDB
    dw $079B, $DB7D  ; MDB
    dw $090F, $C000  ; Screen subpixel X position
    dw $0911, $0500  ; Screen X position in pixels
...
preset_kpdr22_tourian_giant_hoppers:
    dw #preset_kpdr22_tourian_metroids_4 ; Tourian: Metroids 4
    dw $078D, $A9E4  ; DDB
    dw $079B, $DBCD  ; MDB
    dw $090F, $1000  ; Screen subpixel X position
    dw $0911, $0000  ; Screen X position in pixels
...
preset_kpdr22_tourian_baby_skip:
    dw #preset_kpdr22_tourian_giant_hoppers ; Tourian: Giant Hoppers
    dw $078D, $AA14  ; DDB
    dw $079B, $DC65  ; MDB
...
preset_kpdr22_tourian_gadora_room:
    dw #preset_kpdr22_tourian_baby_skip ; Tourian: Baby Skip
    dw $078D, $AA44  ; DDB
    dw $079B, $DCFF  ; MDB
    dw $07F3, $001E  ; Music Bank
    dw $07F5, $0005  ; Music Track
...
preset_kpdr22_tourian_zeb_skip:
    dw #preset_kpdr22_tourian_gadora_room ; Tourian: Gadora Room
    dw $078D, $AAA4  ; DDB
    dw $079B, $DDF3  ; MDB
    dw $090F, $E000  ; Screen subpixel X position
    dw $0913, $0000  ; Screen subpixel Y position
...
preset_kpdr22_tourian_mother_brain_2:
    dw #preset_kpdr22_tourian_zeb_skip ; Tourian: Zeb Skip
    dw $078D, $AAC8  ; DDB
    dw $079B, $DD58  ; MDB
...
preset_kpdr22_tourian_mother_brain_3:
    dw #preset_kpdr22_tourian_mother_brain_2 ; Tourian: Mother Brain 2
    dw $09A6, $1009  ; Equipped Beams
    dw $09C2, $01F3  ; Health
    dw $09C6, $0000  ; Missiles
    dw $09CE, $0000  ; Pbs
...
preset_kpdr22_tourian_zebes_escape:
    dw #preset_kpdr22_tourian_mother_brain_3 ; Tourian: Mother Brain 3
    dw $0A1C, $009B  ; Samus position/state
    dw $0A1E, $0000  ; More position/state
    dw $0AF6, $0025  ; Samus X
...
preset_kpdr22_tourian_escape_room_3:
    dw #preset_kpdr22_tourian_zebes_escape ; Tourian: Zebes Escape
    dw $078D, $AAEC  ; DDB
    dw $079B, $DE7A  ; MDB
    dw $07F3, $0024  ; Music Bank
    dw $07F5, $0007  ; Music Track
...
preset_kpdr22_tourian_escape_room_4:
    dw #preset_kpdr22_tourian_escape_room_3 ; Tourian: Escape Room 3
    dw $078D, $AB04  ; DDB
    dw $079B, $DEA7  ; MDB
    dw $090F, $3000  ; Screen subpixel X position
    dw $0911, $0500  ; Screen X position in pixels
...
preset_kpdr22_tourian_escape_climb:
    dw #preset_kpdr22_tourian_escape_room_4 ; Tourian: Escape Room 4
    dw $078D, $AB1C  ; DDB
    dw $079B, $DEDE  ; MDB
    dw $090F, $0000  ; Screen subpixel X position
...
preset_kpdr22_tourian_escape_parlor:
    dw #preset_kpdr22_tourian_escape_climb ; Tourian: Escape Climb
    dw $078D, $AB34  ; DDB
    dw $079B, $96BA  ; MDB
    dw $090F, $BFFF  ; Screen subpixel X position
    dw $0911, $0100  ; Screen X position in pixels
