...
presets_gtclassic_tourian_mother_brain_2:
    %cm_preset("Mother Brain 2", #preset_gtclassic_tourian_mother_brain_2)

presets_gtclassic_tourian_zebes_escape:
    %cm_preset("Zebes Escape", #preset_gtclassic_tourian_zebes_escape)
...
presets_gtclassic_tourian_escape_climb:
    %cm_preset("Escape Climb", #preset_gtclassic_tourian_escape_climb)
