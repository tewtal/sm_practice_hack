...
preset_kpdr25_crateria_ceres_escape:
    dw #preset_kpdr25_crateria_ceres_elevator ; Crateria: Ceres Elevator
    dw $078D, $ABAC  ; DDB
    dw $079B, $E0B5  ; MDB
...
preset_kpdr25_crateria_ceres_last_3_rooms:
    dw #preset_kpdr25_crateria_ceres_escape ; Crateria: Ceres Escape
    dw $078D, $ABA0  ; DDB
    dw $079B, $E021  ; MDB
...
preset_kpdr25_crateria_ship:
    dw #preset_kpdr25_crateria_ceres_last_3_rooms ; Crateria: Ceres Last 3 Rooms
    dw $078D, $88FE  ; DDB
    dw $079B, $91F8  ; MDB
...
preset_kpdr25_crateria_parlor:
    dw #preset_kpdr25_crateria_ship ; Crateria: Ship
    dw $090F, $0000  ; Screen subpixel X position
    dw $0911, $0000  ; Screen X position in pixels
...
preset_kpdr25_crateria_parlor_downback:
    dw #preset_kpdr25_crateria_parlor ; Crateria: Parlor
    dw $078D, $8916  ; DDB
    dw $079B, $92FD  ; MDB
...
preset_kpdr25_crateria_climb_down:
    dw #preset_kpdr25_crateria_parlor_downback ; Crateria: Parlor Downback
...
preset_kpdr25_crateria_pit_room:
    dw #preset_kpdr25_crateria_climb_down ; Crateria: Climb Down
    dw $078D, $898E  ; DDB
    dw $079B, $96BA  ; MDB
...
preset_kpdr25_crateria_morph:
    dw #preset_kpdr25_crateria_pit_room ; Crateria: Pit Room
    dw $078D, $8B9E  ; DDB
    dw $079B, $9E9F  ; MDB
    dw $07F5, $0007  ; Music Track
...
preset_kpdr25_crateria_construction_zone:
    dw #preset_kpdr25_crateria_morph ; Crateria: Morph
...
preset_kpdr25_crateria_construction_zone_revisit:
    dw #preset_kpdr25_crateria_construction_zone ; Crateria: Construction Zone
    dw $078D, $8EDA  ; DDB
    dw $079B, $A107  ; MDB
...
preset_kpdr25_crateria_pit_room_revisit:
    dw #preset_kpdr25_crateria_construction_zone_revisit ; Crateria: Construction Zone Revisit
    dw $078D, $8EB6  ; DDB
    dw $079B, $97B5  ; MDB
...
preset_kpdr25_crateria_climb_up:
    dw #preset_kpdr25_crateria_pit_room_revisit ; Crateria: Pit Room Revisit
    dw $078D, $8B92  ; DDB
    dw $079B, $975C  ; MDB
...
preset_kpdr25_crateria_parlor_revisit:
    dw #preset_kpdr25_crateria_climb_up ; Crateria: Climb Up
    dw $078D, $8B7A  ; DDB
    dw $079B, $96BA  ; MDB
    dw $090F, $0000  ; Screen subpixel X position
    dw $0911, $0100  ; Screen X position in pixels
...
preset_kpdr25_crateria_flyway:
    dw #preset_kpdr25_crateria_parlor_revisit ; Crateria: Parlor Revisit
    dw $078D, $8B3E  ; DDB
    dw $079B, $92FD  ; MDB
...
preset_kpdr25_crateria_bomb_torizo:
    dw #preset_kpdr25_crateria_flyway ; Crateria: Flyway
    dw $078D, $8982  ; DDB
    dw $079B, $9879  ; MDB
    dw $090F, $4000  ; Screen subpixel X position
...
preset_kpdr25_crateria_alcatraz:
    dw #preset_kpdr25_crateria_bomb_torizo ; Crateria: Bomb Torizo
    dw $078D, $8BAA  ; DDB
...
preset_kpdr25_crateria_terminator:
    dw #preset_kpdr25_crateria_alcatraz ; Crateria: Alcatraz
    dw $078D, $8BB6  ; DDB
    dw $079B, $92FD  ; MDB
    dw $090F, $6000  ; Screen subpixel X position
    dw $0911, $0100  ; Screen X position in pixels
...
preset_kpdr25_crateria_green_pirate_shaft:
    dw #preset_kpdr25_crateria_terminator ; Crateria: Terminator
    dw $078D, $895E  ; DDB
    dw $079B, $990D  ; MDB
...
preset_kpdr25_brinstar_green_brinstar_elevator:
    dw #preset_kpdr25_crateria_green_pirate_shaft ; Crateria: Green Pirate Shaft
    dw $078D, $8C22  ; DDB
    dw $079B, $9938  ; MDB
    dw $07F5, $0003  ; Music Track
    dw $090F, $8000  ; Screen subpixel X position
...
preset_kpdr25_brinstar_early_supers:
    dw #preset_kpdr25_brinstar_green_brinstar_elevator ; Brinstar: Green Brinstar Elevator
    dw $078D, $8C0A  ; DDB
    dw $079B, $9AD9  ; MDB
...
preset_kpdr25_brinstar_dachora_room:
    dw #preset_kpdr25_brinstar_early_supers ; Brinstar: Early Supers
    dw $078D, $8D4E  ; DDB
...
preset_kpdr25_brinstar_big_pink:
    dw #preset_kpdr25_brinstar_dachora_room ; Brinstar: Dachora Room
    dw $078D, $8CE2  ; DDB
    dw $079B, $9CB3  ; MDB
...
preset_kpdr25_brinstar_green_hill_zone:
    dw #preset_kpdr25_brinstar_big_pink ; Brinstar: Big Pink
    dw $078D, $8DAE  ; DDB
    dw $079B, $9D19  ; MDB
    dw $090F, $8000  ; Screen subpixel X position
    dw $0911, $0300  ; Screen X position in pixels
...
preset_kpdr25_brinstar_noob_bridge:
    dw #preset_kpdr25_brinstar_green_hill_zone ; Brinstar: Green Hill Zone
    dw $078D, $8DEA  ; DDB
    dw $079B, $9E52  ; MDB
    dw $090F, $0000  ; Screen subpixel X position
    dw $0911, $0700  ; Screen X position in pixels
...
preset_kpdr25_brinstar_red_tower:
    dw #preset_kpdr25_brinstar_noob_bridge ; Brinstar: Noob Bridge
    dw $078D, $8E92  ; DDB
    dw $079B, $9FBA  ; MDB
...
preset_kpdr25_brinstar_skree_boost:
    dw #preset_kpdr25_brinstar_red_tower ; Brinstar: Red Tower
    dw $078D, $8F0A  ; DDB
    dw $079B, $A253  ; MDB
...
preset_kpdr25_brinstar_below_spazer:
    dw #preset_kpdr25_brinstar_skree_boost ; Brinstar: Skree Boost
    dw $078D, $9042  ; DDB
    dw $079B, $A3DD  ; MDB
...
preset_kpdr25_brinstar_spazer:
    dw #preset_kpdr25_brinstar_below_spazer ; Brinstar: Below Spazer
    dw $078D, $9102  ; DDB
    dw $079B, $A408  ; MDB
    dw $090F, $2000  ; Screen subpixel X position
...
preset_kpdr25_brinstar_leaving_spazer:
    dw #preset_kpdr25_brinstar_spazer ; Brinstar: Spazer
    dw $078D, $9126  ; DDB
    dw $079B, $A447  ; MDB
    dw $07F5, $0003  ; Music Track
    dw $090F, $D000  ; Screen subpixel X position
...
preset_kpdr25_brinstar_passing_through_maridia:
    dw #preset_kpdr25_brinstar_leaving_spazer ; Brinstar: Leaving Spazer
    dw $078D, $9132  ; DDB
    dw $079B, $A408  ; MDB
    dw $07F5, $0005  ; Music Track
    dw $090F, $8000  ; Screen subpixel X position
...
preset_kpdr25_kraid_entering_kraids_lair:
    dw #preset_kpdr25_brinstar_passing_through_maridia ; Brinstar: Passing Through Maridia
    dw $078D, $A348  ; DDB
    dw $079B, $CF80  ; MDB
    dw $090F, $4000  ; Screen subpixel X position
    dw $0911, $0000  ; Screen X position in pixels
...
preset_kpdr25_kraid_warehouse_zeelas:
    dw #preset_kpdr25_kraid_entering_kraids_lair ; Kraid: Entering Kraid's Lair
    dw $078D, $A384  ; DDB
    dw $079B, $A6A1  ; MDB
    dw $07F5, $0003  ; Music Track
    dw $090F, $C000  ; Screen subpixel X position
...
preset_kpdr25_kraid_kraid_kihunters:
    dw #preset_kpdr25_kraid_warehouse_zeelas ; Kraid: Warehouse Zeelas
    dw $078D, $923A  ; DDB
    dw $079B, $A471  ; MDB
    dw $07F5, $0005  ; Music Track
    dw $090F, $8000  ; Screen subpixel X position
...
preset_kpdr25_kraid_minikraid:
    dw #preset_kpdr25_kraid_kraid_kihunters ; Kraid: Kraid Kihunters
    dw $078D, $9156  ; DDB
    dw $079B, $A4DA  ; MDB
...
preset_kpdr25_kraid_fallen_hero:
    dw #preset_kpdr25_kraid_minikraid ; Kraid: Mini-Kraid
    dw $078D, $917A  ; DDB
    dw $079B, $A521  ; MDB
...
preset_kpdr25_kraid_kraid:
    dw #preset_kpdr25_kraid_fallen_hero ; Kraid: Fallen Hero
    dw $078D, $919E  ; DDB
    dw $079B, $A56B  ; MDB
...
preset_kpdr25_kraid_leaving_varia:
    dw #preset_kpdr25_kraid_kraid ; Kraid: Kraid
    dw $078D, $91DA  ; DDB
    dw $079B, $A6E2  ; MDB
    dw $07F5, $0003  ; Music Track
...
preset_kpdr25_kraid_minikraid_revisit:
    dw #preset_kpdr25_kraid_arthur_j_metroid ; Kraid: Arthur J. Metroid
    dw $078D, $91CE  ; DDB
    dw $079B, $A56B  ; MDB
    dw $090F, $3000  ; Screen subpixel X position
...
preset_kpdr25_kraid_kraid_kihunters_revisit:
    dw #preset_kpdr25_kraid_minikraid_revisit ; Kraid: Mini-Kraid Revisit
    dw $078D, $91AA  ; DDB
    dw $079B, $A521  ; MDB
...
preset_kpdr25_kraid_kraid_etank:
    dw #preset_kpdr25_kraid_kraid_kihunters_revisit ; Kraid: Kraid Kihunters Revisit
    dw $078D, $916E  ; DDB
    dw $079B, $A471  ; MDB
    dw $07F3, $0012  ; Music Bank
    dw $07F5, $0005  ; Music Track
...
preset_kpdr25_kraid_business_center_preelev:
    dw #preset_kpdr25_kraid_leaving_kraid_etank ; Kraid: Leaving Kraid E-Tank
    dw $078D, $913E  ; DDB
    dw $079B, $A6A1  ; MDB
    dw $07F5, $0003  ; Music Track
    dw $090F, $3000  ; Screen subpixel X position
...
preset_kpdr25_upper_norfair_business_center_postelev:
    dw #preset_kpdr25_kraid_business_center_preelev ; Kraid: Business Center Pre-Elev
    dw $078D, $9246  ; DDB
    dw $079B, $A7DE  ; MDB
...
preset_kpdr25_upper_norfair_hijump_etank:
    dw #preset_kpdr25_upper_norfair_business_center_postelev ; Upper Norfair: Business Center Post-Elev
...
preset_kpdr25_upper_norfair_leaving_hijump:
    dw #preset_kpdr25_upper_norfair_hijump_etank ; Upper Norfair: Hi-Jump E-Tank
    dw $078D, $9426  ; DDB
    dw $079B, $A9E5  ; MDB
    dw $07F5, $0003  ; Music Track
...
preset_kpdr25_upper_norfair_business_center_revisit:
    dw #preset_kpdr25_upper_norfair_leaving_hijump ; Upper Norfair: Leaving Hi-Jump
    dw $078D, $93F6  ; DDB
    dw $079B, $AA41  ; MDB
    dw $07F5, $0005  ; Music Track
    dw $090F, $4000  ; Screen subpixel X position
...
preset_kpdr25_upper_norfair_precathedral:
    dw #preset_kpdr25_upper_norfair_business_center_revisit ; Upper Norfair: Business Center Revisit
    dw $078D, $941A  ; DDB
    dw $079B, $A7DE  ; MDB
    dw $090F, $B000  ; Screen subpixel X position
    dw $0911, $0000  ; Screen X position in pixels
...
preset_kpdr25_upper_norfair_rising_tide:
    dw #preset_kpdr25_upper_norfair_cathedral ; Upper Norfair: Cathedral
    dw $078D, $92B2  ; DDB
    dw $079B, $A788  ; MDB
...
preset_kpdr25_upper_norfair_single_chamber:
    dw #preset_kpdr25_upper_norfair_bat_cave_revisit ; Upper Norfair: Bat Cave Revisit
    dw $078D, $97AA  ; DDB
    dw $079B, $ACB3  ; MDB
    dw $090F, $7FFF  ; Screen subpixel X position
    dw $0911, $0100  ; Screen X position in pixels
...
preset_kpdr25_upper_norfair_double_chamber_revisit:
    dw #preset_kpdr25_upper_norfair_double_chamber ; Upper Norfair: Double Chamber
    dw $078D, $961E  ; DDB
    dw $079B, $ADDE  ; MDB
    dw $07F5, $0003  ; Music Track
    dw $090F, $1000  ; Screen subpixel X position
...
preset_kpdr25_upper_norfair_single_chamber_revisit:
    dw #preset_kpdr25_upper_norfair_double_chamber_revisit ; Upper Norfair: Double Chamber Revisit
    dw $078D, $962A  ; DDB
    dw $079B, $ADAD  ; MDB
    dw $07F5, $0005  ; Music Track
    dw $090F, $3000  ; Screen subpixel X position
...
preset_kpdr25_upper_norfair_bubble_mountain_revisit:
    dw #preset_kpdr25_upper_norfair_single_chamber_revisit ; Upper Norfair: Single Chamber Revisit
    dw $078D, $9606  ; DDB
    dw $079B, $AD5E  ; MDB
    dw $090F, $1000  ; Screen subpixel X position
...
preset_kpdr25_upper_norfair_frog_speedway:
    dw #preset_kpdr25_upper_norfair_bubble_mountain_revisit ; Upper Norfair: Bubble Mountain Revisit
    dw $078D, $956A  ; DDB
    dw $079B, $AF72  ; MDB
    dw $090F, $5000  ; Screen subpixel X position
    dw $0913, $1400  ; Screen subpixel Y position
...
preset_kpdr25_red_brinstar_reverse_skree_boost:
    dw #preset_kpdr25_red_brinstar_alpha_spark ; Red Brinstar: Alpha Spark
    dw $078D, $A36C  ; DDB
    dw $079B, $A408  ; MDB
    dw $07F5, $0005  ; Music Track
    dw $090F, $C000  ; Screen subpixel X position
...
preset_kpdr25_red_brinstar_red_tower_climb:
    dw #preset_kpdr25_red_brinstar_reverse_skree_boost ; Red Brinstar: Reverse Skree Boost
    dw $078D, $910E  ; DDB
    dw $079B, $A3DD  ; MDB
    dw $090F, $0000  ; Screen subpixel X position
    dw $0913, $EC00  ; Screen subpixel Y position
...
preset_kpdr25_red_brinstar_hellway:
    dw #preset_kpdr25_red_brinstar_red_tower_climb ; Red Brinstar: Red Tower Climb
    dw $078D, $90F6  ; DDB
    dw $079B, $A253  ; MDB
    dw $090F, $D000  ; Screen subpixel X position
    dw $0913, $6800  ; Screen subpixel Y position
...
preset_kpdr25_red_brinstar_caterpillars_down:
    dw #preset_kpdr25_red_brinstar_hellway ; Red Brinstar: Hellway
    dw $078D, $901E  ; DDB
    dw $079B, $A2F7  ; MDB
    dw $090F, $0000  ; Screen subpixel X position
...
preset_kpdr25_red_brinstar_alpha_power_bombs:
    dw #preset_kpdr25_red_brinstar_caterpillars_down ; Red Brinstar: Caterpillars Down
    dw $078D, $908A  ; DDB
    dw $079B, $A322  ; MDB
    dw $090F, $D000  ; Screen subpixel X position
    dw $0911, $0000  ; Screen X position in pixels
...
preset_kpdr25_red_brinstar_caterpillars_up:
    dw #preset_kpdr25_red_brinstar_alpha_power_bombs ; Red Brinstar: Alpha Power Bombs
    dw $078D, $9096  ; DDB
    dw $079B, $A3AE  ; MDB
    dw $07F5, $0003  ; Music Track
    dw $090F, $4000  ; Screen subpixel X position
...
preset_kpdr25_wrecked_ship_crateria_kihunters:
    dw #preset_kpdr25_red_brinstar_caterpillars_up ; Red Brinstar: Caterpillars Up
    dw $078D, $90BA  ; DDB
    dw $079B, $962A  ; MDB
    dw $090F, $0000  ; Screen subpixel X position
    dw $0911, $0000  ; Screen X position in pixels
...
preset_kpdr25_wrecked_ship_ocean_fly_setup:
    dw #preset_kpdr25_wrecked_ship_crateria_kihunters ; Wrecked Ship: Crateria Kihunters
    dw $078D, $8AF6  ; DDB
    dw $079B, $948C  ; MDB
    dw $07F5, $0005  ; Music Track
...
preset_kpdr25_wrecked_ship_ocean_spark:
    dw #preset_kpdr25_wrecked_ship_ocean_fly_setup ; Wrecked Ship: Ocean Fly Setup
    dw $078D, $8A36  ; DDB
    dw $079B, $95FF  ; MDB
...
preset_kpdr25_wrecked_ship_basement:
    dw #preset_kpdr25_wrecked_ship_entering_wrecked_ship ; Wrecked Ship: Entering Wrecked Ship
    dw $078D, $A1BC  ; DDB
    dw $079B, $CAF6  ; MDB
...
preset_kpdr25_wrecked_ship_phantoon:
    dw #preset_kpdr25_wrecked_ship_basement ; Wrecked Ship: Basement
    dw $078D, $A21C  ; DDB
    dw $079B, $CC6F  ; MDB
    dw $090F, $F000  ; Screen subpixel X position
    dw $0913, $7000  ; Screen subpixel Y position
...
preset_kpdr25_wrecked_ship_shaft_to_supers:
    dw #preset_kpdr25_wrecked_ship_leaving_phantoon ; Wrecked Ship: Leaving Phantoon
    dw $078D, $A2C4  ; DDB
    dw $079B, $CC6F  ; MDB
    dw $07F5, $0006  ; Music Track
    dw $090F, $8000  ; Screen subpixel X position
...
preset_kpdr25_wrecked_ship_wrecked_ship_shaft:
    dw #preset_kpdr25_wrecked_ship_shaft_to_supers ; Wrecked Ship: Shaft To Supers
    dw $078D, $A210  ; DDB
    dw $079B, $CDA8  ; MDB
    dw $090F, $3000  ; Screen subpixel X position
    dw $0911, $0000  ; Screen X position in pixels
...
preset_kpdr25_wrecked_ship_attic:
    dw #preset_kpdr25_wrecked_ship_wrecked_ship_shaft ; Wrecked Ship: Wrecked Ship Shaft
    dw $078D, $A2E8  ; DDB
    dw $079B, $CAF6  ; MDB
...
preset_kpdr25_wrecked_ship_pancakes_and_wavers:
    dw #preset_kpdr25_wrecked_ship_upper_west_ocean ; Wrecked Ship: Upper West Ocean
    dw $078D, $A1E0  ; DDB
    dw $079B, $93FE  ; MDB
    dw $07F3, $000C  ; Music Bank
    dw $07F5, $0005  ; Music Track
...
preset_kpdr25_wrecked_ship_bowling_spark:
    dw #preset_kpdr25_wrecked_ship_pancakes_and_wavers ; Wrecked Ship: Pancakes and Wavers
    dw $078D, $89E2  ; DDB
    dw $079B, $9461  ; MDB
    dw $090F, $6800  ; Screen subpixel X position
    dw $0911, $0100  ; Screen X position in pixels
...
preset_kpdr25_wrecked_ship_leaving_gravity:
    dw #preset_kpdr25_wrecked_ship_bowling_spark ; Wrecked Ship: Bowling Spark
    dw $078D, $A1A4  ; DDB
    dw $079B, $CE40  ; MDB
    dw $07F3, $0030  ; Music Bank
    dw $07F5, $0003  ; Music Track
...
preset_kpdr25_wrecked_ship_moat_ball:
    dw #preset_kpdr25_wrecked_ship_leaving_gravity ; Wrecked Ship: Leaving Gravity
    dw $078D, $A300  ; DDB
    dw $079B, $93FE  ; MDB
    dw $07F3, $000C  ; Music Bank
    dw $07F5, $0005  ; Music Track
...
preset_kpdr25_wrecked_ship_crateria_kihunters_return:
    dw #preset_kpdr25_wrecked_ship_moat_ball ; Wrecked Ship: Moat Ball
    dw $078D, $89CA  ; DDB
    dw $079B, $95FF  ; MDB
...
preset_kpdr25_red_brinstar_revisit_red_brinstar_elevator:
    dw #preset_kpdr25_wrecked_ship_crateria_kihunters_return ; Wrecked Ship: Crateria Kihunters Return
    dw $078D, $8A42  ; DDB
    dw $079B, $962A  ; MDB
    dw $07F5, $0003  ; Music Track
    dw $090F, $7000  ; Screen subpixel X position
...
preset_kpdr25_red_brinstar_revisit_caterpillars_revisit:
    dw #preset_kpdr25_red_brinstar_revisit_red_brinstar_elevator ; Red Brinstar Revisit: Red Brinstar Elevator
    dw $078D, $8B02  ; DDB
    dw $079B, $A322  ; MDB
    dw $07F3, $0012  ; Music Bank
    dw $07F5, $0005  ; Music Track
...
preset_kpdr25_red_brinstar_revisit_hellway_revisit:
    dw #preset_kpdr25_red_brinstar_revisit_caterpillars_revisit ; Red Brinstar Revisit: Caterpillars Revisit
    dw $090F, $C000  ; Screen subpixel X position
    dw $0913, $2800  ; Screen subpixel Y position
...
preset_kpdr25_red_brinstar_revisit_red_tower_down:
    dw #preset_kpdr25_red_brinstar_revisit_hellway_revisit ; Red Brinstar Revisit: Hellway Revisit
    dw $078D, $90AE  ; DDB
    dw $079B, $A2F7  ; MDB
...
preset_kpdr25_red_brinstar_revisit_skree_boost_final:
    dw #preset_kpdr25_red_brinstar_revisit_red_tower_down ; Red Brinstar Revisit: Red Tower Down
    dw $078D, $907E  ; DDB
    dw $079B, $A253  ; MDB
...
preset_kpdr25_red_brinstar_revisit_below_spazer_final:
    dw #preset_kpdr25_red_brinstar_revisit_skree_boost_final ; Red Brinstar Revisit: Skree Boost Final
    dw $078D, $9042  ; DDB
    dw $079B, $A3DD  ; MDB
...
preset_kpdr25_red_brinstar_revisit_breaking_the_tube:
    dw #preset_kpdr25_red_brinstar_revisit_below_spazer_final ; Red Brinstar Revisit: Below Spazer Final
    dw $078D, $9102  ; DDB
    dw $079B, $A408  ; MDB
    dw $090F, $C000  ; Screen subpixel X position
    dw $0913, $D000  ; Screen subpixel Y position
...
preset_kpdr25_maridia_fish_tank:
    dw #preset_kpdr25_red_brinstar_revisit_breaking_the_tube ; Red Brinstar Revisit: Breaking The Tube
    dw $078D, $A330  ; DDB
    dw $079B, $CFC9  ; MDB
...
preset_kpdr25_maridia_crab_shaft:
    dw #preset_kpdr25_maridia_mt_everest ; Maridia: Mt. Everest
    dw $090F, $E000  ; Screen subpixel X position
    dw $0911, $0500  ; Screen X position in pixels
...
preset_kpdr25_maridia_botwoon_hallway:
    dw #preset_kpdr25_maridia_aqueduct ; Maridia: Aqueduct
    dw $078D, $A4C8  ; DDB
    dw $079B, $D5A7  ; MDB
    dw $07F5, $0005  ; Music Track
    dw $090F, $A000  ; Screen subpixel X position
...
preset_kpdr25_maridia_botwoon:
    dw #preset_kpdr25_maridia_botwoon_hallway ; Maridia: Botwoon Hallway
    dw $078D, $A72C  ; DDB
    dw $079B, $D617  ; MDB
...
preset_kpdr25_maridia_halfie_setup:
    dw #preset_kpdr25_maridia_botwoon_etank ; Maridia: Botwoon E-Tank
    dw $078D, $A918  ; DDB
    dw $079B, $D7E4  ; MDB
    dw $07F3, $001B  ; Music Bank
    dw $07F5, $0005  ; Music Track
...
preset_kpdr25_maridia_draygon:
    dw #preset_kpdr25_maridia_halfie_setup ; Maridia: Halfie Setup
    dw $078D, $A7F8  ; DDB
    dw $079B, $D78F  ; MDB
    dw $090F, $3000  ; Screen subpixel X position
    dw $0913, $E400  ; Screen subpixel Y position
...
preset_kpdr25_maridia_whomple_jump:
    dw #preset_kpdr25_maridia_reverse_halfie_spikesuit ; Maridia: Reverse Halfie (Spikesuit)
    dw $0A68, $0000  ; Flash suit
    dw #$FFFF
...
preset_kpdr25_maridia_cac_alley_west:
    dw #preset_kpdr25_maridia_cac_alley_east ; Maridia: Cac Alley East
    dw $078D, $A900  ; DDB
    dw $079B, $DA2B  ; MDB
    dw $090F, $B000  ; Screen subpixel X position
    dw $0915, $0002  ; Screen Y position in pixels
...
preset_kpdr25_maridia_plasma_spark:
    dw #preset_kpdr25_maridia_cac_alley_west ; Maridia: Cac Alley West
    dw $078D, $A93C  ; DDB
    dw $079B, $D5EC  ; MDB
    dw $090F, $2000  ; Screen subpixel X position
...
preset_kpdr25_maridia_plasma_climb:
    dw #preset_kpdr25_maridia_plasma_spark ; Maridia: Plasma Spark
    dw $078D, $A750  ; DDB
    dw $079B, $D340  ; MDB
...
preset_kpdr25_maridia_plasma_beam:
    dw #preset_kpdr25_maridia_plasma_climb ; Maridia: Plasma Climb
    dw $078D, $A5DC  ; DDB
    dw $079B, $D27E  ; MDB
    dw $090F, $9000  ; Screen subpixel X position
    dw $0911, $0000  ; Screen X position in pixels
...
preset_kpdr25_maridia_plasma_spark_revisit:
    dw #preset_kpdr25_maridia_plasma_beam ; Maridia: Plasma Beam
    dw $078D, $A540  ; DDB
    dw $079B, $D387  ; MDB
    dw $090F, $8000  ; Screen subpixel X position
    dw $0913, $0000  ; Screen subpixel Y position
...
preset_kpdr25_maridia_sewers:
    dw #preset_kpdr25_maridia_toilet ; Maridia: Toilet
    dw $078D, $A600  ; DDB
    dw $079B, $D48E  ; MDB
    dw $090F, $0000  ; Screen subpixel X position
    dw $0911, $0000  ; Screen X position in pixels
...
preset_kpdr25_maridia_lower_maridia_gate:
    dw #preset_kpdr25_maridia_sewers ; Maridia: Sewers
    dw $078D, $A528  ; DDB
    dw $079B, $D21C  ; MDB
    dw $090F, $8000  ; Screen subpixel X position
...
preset_kpdr25_maridia_business_center_revisit:
    dw #preset_kpdr25_maridia_lower_maridia_gate ; Maridia: Lower Maridia Gate
    dw $078D, $9246  ; DDB
    dw $079B, $A7DE  ; MDB
    dw $07F3, $0015  ; Music Bank
    dw $0913, $0000  ; Screen subpixel Y position
...
preset_kpdr25_lower_norfair_magdollite_tunnel:
    dw #preset_kpdr25_maridia_business_center_revisit ; Maridia: Business Center Revisit
    dw $078D, $9576  ; DDB
    dw $079B, $AEDF  ; MDB
...
preset_kpdr25_lower_norfair_prepillars:
    dw #preset_kpdr25_lower_norfair_ln_main_hall ; Lower Norfair: LN Main Hall
    dw $090F, $9000  ; Screen subpixel X position
    dw $0911, $0700  ; Screen X position in pixels
    dw $0913, $E400  ; Screen subpixel Y position
    dw $0917, $0540  ; Layer 2 X position
...
preset_kpdr25_lower_norfair_fast_pillars_setup:
    dw #preset_kpdr25_lower_norfair_prepillars ; Lower Norfair: Pre-Pillars
    dw $078D, $989A  ; DDB
    dw $079B, $B3A5  ; MDB
...
preset_kpdr25_lower_norfair_worst_room_in_the_game:
    dw #preset_kpdr25_lower_norfair_fast_pillars_setup ; Lower Norfair: Fast Pillars Setup
    dw $078D, $9912  ; DDB
    dw $079B, $B457  ; MDB
...
preset_kpdr25_lower_norfair_amphitheatre:
    dw #preset_kpdr25_lower_norfair_worst_room_in_the_game ; Lower Norfair: Worst Room In The Game
    dw $078D, $994E  ; DDB
    dw $079B, $B4AD  ; MDB
    dw $090F, $C000  ; Screen subpixel X position
    dw $0911, $0000  ; Screen X position in pixels
...
preset_kpdr25_lower_norfair_wasteland:
    dw #preset_kpdr25_lower_norfair_kihunter_stairs_down ; Lower Norfair: Kihunter Stairs Down
    dw $078D, $99A2  ; DDB
    dw $079B, $B585  ; MDB
    dw $090F, $8000  ; Screen subpixel X position
    dw $0911, $0200  ; Screen X position in pixels
...
preset_kpdr25_lower_norfair_metal_ninja_pirates:
    dw #preset_kpdr25_lower_norfair_wasteland ; Lower Norfair: Wasteland
    dw $078D, $99EA  ; DDB
    dw $079B, $B5D5  ; MDB
    dw $090F, $E000  ; Screen subpixel X position
    dw $0911, $0100  ; Screen X position in pixels
...
preset_kpdr25_lower_norfair_plowerhouse:
    dw #preset_kpdr25_lower_norfair_metal_ninja_pirates ; Lower Norfair: Metal Ninja Pirates
    dw $078D, $9A1A  ; DDB
    dw $079B, $B62B  ; MDB
    dw $090F, $7000  ; Screen subpixel X position
    dw $0911, $0000  ; Screen X position in pixels
...
preset_kpdr25_lower_norfair_ridley:
    dw #preset_kpdr25_lower_norfair_plowerhouse ; Lower Norfair: Plowerhouse
    dw $078D, $995A  ; DDB
    dw $079B, $B37A  ; MDB
    dw $090F, $2000  ; Screen subpixel X position
    dw $0913, $5000  ; Screen subpixel Y position
...
preset_kpdr25_lower_norfair_reverse_plowerhouse:
    dw #preset_kpdr25_lower_norfair_leaving_ridley ; Lower Norfair: Leaving Ridley
    dw $078D, $98BE  ; DDB
    dw $079B, $B37A  ; MDB
    dw $07F3, $0018  ; Music Bank
    dw $07F5, $0005  ; Music Track
...
preset_kpdr25_lower_norfair_wasteland_revisit:
    dw #preset_kpdr25_lower_norfair_reverse_plowerhouse ; Lower Norfair: Reverse Plowerhouse
    dw $078D, $9966  ; DDB
    dw $079B, $B62B  ; MDB
    dw $090F, $9000  ; Screen subpixel X position
    dw $0913, $7400  ; Screen subpixel Y position
...
preset_kpdr25_lower_norfair_fireflea_room:
    dw #preset_kpdr25_lower_norfair_kihunter_stairs_up ; Lower Norfair: Kihunter Stairs Up
    dw $078D, $9A26  ; DDB
    dw $079B, $B585  ; MDB
    dw $090F, $D000  ; Screen subpixel X position
    dw $0911, $0000  ; Screen X position in pixels
...
preset_kpdr25_lower_norfair_three_musketeers:
    dw #preset_kpdr25_lower_norfair_springball_maze ; Lower Norfair: Springball Maze
    dw $078D, $9A92  ; DDB
    dw $079B, $B510  ; MDB
...
preset_kpdr25_lower_norfair_bubble_mountain_final:
    dw #preset_kpdr25_lower_norfair_single_chamber_final ; Lower Norfair: Single Chamber Final
    dw $078D, $9A4A  ; DDB
    dw $079B, $AD5E  ; MDB
    dw $07F3, $0015  ; Music Bank
    dw $090F, $8000  ; Screen subpixel X position
...
preset_kpdr25_lower_norfair_business_center_final:
    dw #preset_kpdr25_lower_norfair_bubble_mountain_final ; Lower Norfair: Bubble Mountain Final
    dw $078D, $97DA  ; DDB
    dw $079B, $B167  ; MDB
    dw $090F, $6000  ; Screen subpixel X position
    dw $0913, $5000  ; Screen subpixel Y position
...
preset_kpdr25_backtracking_maridia_tube_revisit:
    dw #preset_kpdr25_lower_norfair_business_center_final ; Lower Norfair: Business Center Final
    dw $078D, $92EE  ; DDB
    dw $079B, $A6A1  ; MDB
    dw $07F3, $0012  ; Music Bank
    dw $07F5, $0003  ; Music Track
...
preset_kpdr25_backtracking_fish_tank_revisit:
    dw #preset_kpdr25_backtracking_maridia_tube_revisit ; Backtracking: Maridia Tube Revisit
    dw $078D, $A330  ; DDB
    dw $079B, $CFC9  ; MDB
    dw $07F3, $001B  ; Music Bank
    dw $07F5, $0006  ; Music Track
...
preset_kpdr25_backtracking_mt_everest_revisit:
    dw #preset_kpdr25_backtracking_fish_tank_revisit ; Backtracking: Fish Tank Revisit
    dw $078D, $A3B4  ; DDB
    dw $079B, $D017  ; MDB
    dw $090F, $E000  ; Screen subpixel X position
...
preset_kpdr25_backtracking_red_brinstar_green_gate:
    dw #preset_kpdr25_backtracking_mt_everest_revisit ; Backtracking: Mt. Everest Revisit
    dw $078D, $A42C  ; DDB
    dw $079B, $D104  ; MDB
...
preset_kpdr25_backtracking_crateria_kihunters_final:
    dw #preset_kpdr25_backtracking_red_brinstar_green_gate ; Backtracking: Red Brinstar Green Gate
    dw $078D, $90BA  ; DDB
    dw $079B, $962A  ; MDB
    dw $07F3, $0012  ; Music Bank
    dw $07F5, $0003  ; Music Track
...
preset_kpdr25_backtracking_parlor_spacejump:
    dw #preset_kpdr25_backtracking_crateria_kihunters_final ; Backtracking: Crateria Kihunters Final
    dw $078D, $8AC6  ; DDB
    dw $079B, $91F8  ; MDB
    dw $07F3, $000C  ; Music Bank
    dw $07F5, $0005  ; Music Track
...
preset_kpdr25_backtracking_terminator_revisit:
    dw #preset_kpdr25_backtracking_parlor_spacejump ; Backtracking: Parlor Spacejump
    dw $078D, $8916  ; DDB
    dw $079B, $92FD  ; MDB
    dw $07F3, $0009  ; Music Bank
    dw $090F, $4000  ; Screen subpixel X position
...
preset_kpdr25_backtracking_green_pirate_shaft_revisit:
    dw #preset_kpdr25_backtracking_terminator_revisit ; Backtracking: Terminator Revisit
    dw $078D, $895E  ; DDB
    dw $079B, $990D  ; MDB
    dw $090F, $0000  ; Screen subpixel X position
    dw $0911, $0000  ; Screen X position in pixels
...
preset_kpdr25_backtracking_g4_hallway:
    dw #preset_kpdr25_backtracking_green_pirate_shaft_revisit ; Backtracking: Green Pirate Shaft Revisit
    dw $078D, $8BE6  ; DDB
    dw $079B, $99BD  ; MDB
    dw $090F, $F000  ; Screen subpixel X position
    dw $0913, $E400  ; Screen subpixel Y position
...
preset_kpdr25_backtracking_g4_elevator:
    dw #preset_kpdr25_backtracking_g4_hallway ; Backtracking: G4 Hallway
    dw $078D, $91F2  ; DDB
    dw $079B, $A66A  ; MDB
    dw $07F5, $0006  ; Music Track
    dw $090F, $7000  ; Screen subpixel X position
...
preset_kpdr25_tourian_tourian_elevator_room:
    dw #preset_kpdr25_backtracking_g4_elevator ; Backtracking: G4 Elevator
    dw $078D, $9222  ; DDB
    dw $079B, $DAAE  ; MDB
...
preset_kpdr25_tourian_metroids_1:
    dw #preset_kpdr25_tourian_tourian_elevator_room ; Tourian: Tourian Elevator Room
    dw $090F, $8000  ; Screen subpixel X position
...
preset_kpdr25_tourian_baby_skip:
    dw #preset_kpdr25_tourian_giant_hoppers ; Tourian: Giant Hoppers
    dw $078D, $AA14  ; DDB
    dw $079B, $DC65  ; MDB
...
preset_kpdr25_tourian_zeb_skip:
    dw #preset_kpdr25_tourian_gadora_room ; Tourian: Gadora Room
    dw $078D, $AAA4  ; DDB
    dw $079B, $DDF3  ; MDB
    dw $090F, $E000  ; Screen subpixel X position
    dw $0913, $0000  ; Screen subpixel Y position
