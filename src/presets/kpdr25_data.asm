...
preset_kpdr25_kraid_warehouse_zeelas:
    dw #preset_kpdr25_kraid_entering_kraids_lair ; Kraid: Entering Kraids Lair
    dw $078D, $A384  ; DDB
    dw $079B, $A6A1  ; MDB
    dw $07F5, $0003  ; Music Track
    dw $090F, $C000  ; Screen subpixel X position
...
preset_kpdr25_kraid_fallen_hero:
    dw #preset_kpdr25_kraid_mini_kraid ; Kraid: Mini Kraid
    dw $078D, $917A  ; DDB
    dw $079B, $A521  ; MDB
...
preset_kpdr25_kraid_kraid_kihunters_revisit:
    dw #preset_kpdr25_kraid_mini_kraid_revisit ; Kraid: Mini Kraid Revisit
    dw $078D, $91AA  ; DDB
    dw $079B, $A521  ; MDB
...
preset_kpdr25_upper_norfair_leaving_hi_jump:
    dw #preset_kpdr25_upper_norfair_hi_jump_etank ; Upper Norfair: Hi Jump E-Tank
    dw $078D, $9426  ; DDB
    dw $079B, $A9E5  ; MDB
    dw $07F5, $0003  ; Music Track
...
preset_kpdr25_upper_norfair_business_center_revisit:
    dw #preset_kpdr25_upper_norfair_leaving_hi_jump ; Upper Norfair: Leaving Hi Jump
    dw $078D, $93F6  ; DDB
    dw $079B, $AA41  ; MDB
    dw $07F5, $0005  ; Music Track
    dw $090F, $4000  ; Screen subpixel X position
...
preset_kpdr25_wrecked_ship_ocean_spark:
    dw #preset_kpdr25_wrecked_ship_oceanfly_setup ; Wrecked Ship: Oceanfly Setup
    dw $078D, $8A36  ; DDB
    dw $079B, $95FF  ; MDB
...
preset_kpdr25_maridia_fish_tank:
    dw #preset_kpdr25_red_brinstar_revisit_breaking_tube ; Red Brinstar Revisit: Breaking Tube
    dw $078D, $A330  ; DDB
    dw $079B, $CFC9  ; MDB
