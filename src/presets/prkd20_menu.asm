...
presets_prkd20_crateria_ceres_elevator:
    %cm_preset("Ceres Elevator", #preset_prkd20_crateria_ceres_elevator)

presets_prkd20_crateria_ceres_escape:
    %cm_preset("Ceres Escape", #preset_prkd20_crateria_ceres_escape)

presets_prkd20_crateria_ceres_last_3_rooms:
    %cm_preset("Ceres Last 3 Rooms", #preset_prkd20_crateria_ceres_last_3_rooms)

presets_prkd20_crateria_ship:
    %cm_preset("Ship", #preset_prkd20_crateria_ship)

presets_prkd20_crateria_parlor:
    %cm_preset("Parlor", #preset_prkd20_crateria_parlor)

presets_prkd20_crateria_parlor_downback:
    %cm_preset("Parlor Downback", #preset_prkd20_crateria_parlor_downback)

presets_prkd20_crateria_climb_down:
    %cm_preset("Climb Down", #preset_prkd20_crateria_climb_down)

presets_prkd20_crateria_pit_room:
    %cm_preset("Pit Room", #preset_prkd20_crateria_pit_room)

presets_prkd20_crateria_morph:
    %cm_preset("Morph", #preset_prkd20_crateria_morph)

presets_prkd20_crateria_construction_zone_down:
    %cm_preset("Construction Zone Down", #preset_prkd20_crateria_construction_zone_down)

presets_prkd20_crateria_construction_zone_up:
    %cm_preset("Construction Zone Up", #preset_prkd20_crateria_construction_zone_up)

presets_prkd20_crateria_pit_room_revisit:
    %cm_preset("Pit Room Revisit", #preset_prkd20_crateria_pit_room_revisit)

presets_prkd20_crateria_climb_up:
    %cm_preset("Climb Up", #preset_prkd20_crateria_climb_up)

presets_prkd20_crateria_parlor_revisit:
    %cm_preset("Parlor Revisit", #preset_prkd20_crateria_parlor_revisit)

presets_prkd20_crateria_flyway:
    %cm_preset("Flyway", #preset_prkd20_crateria_flyway)

presets_prkd20_crateria_bomb_torizo:
    %cm_preset("Bomb Torizo", #preset_prkd20_crateria_bomb_torizo)

presets_prkd20_crateria_alcatraz:
    %cm_preset("Alcatraz", #preset_prkd20_crateria_alcatraz)
...
presets_prkd20_crateria_green_pirate_shaft:
    %cm_preset("Green Pirate Shaft", #preset_prkd20_crateria_green_pirate_shaft)


; Brinstar
presets_prkd20_brinstar_green_brinstar_elevator:
    %cm_preset("Green Brinstar Elevator", #preset_prkd20_brinstar_green_brinstar_elevator)

presets_prkd20_brinstar_early_supers:
    %cm_preset("Early Supers", #preset_prkd20_brinstar_early_supers)

presets_prkd20_brinstar_dachora_room:
    %cm_preset("Dachora Room", #preset_prkd20_brinstar_dachora_room)

presets_prkd20_brinstar_big_pink:
    %cm_preset("Big Pink", #preset_prkd20_brinstar_big_pink)

presets_prkd20_brinstar_green_hill_zone:
    %cm_preset("Green Hill Zone", #preset_prkd20_brinstar_green_hill_zone)
...
presets_prkd20_brinstar_red_tower:
    %cm_preset("Red Tower", #preset_prkd20_brinstar_red_tower)

presets_prkd20_brinstar_hellway:
    %cm_preset("Hellway", #preset_prkd20_brinstar_hellway)

presets_prkd20_brinstar_caterpillars_down:
    %cm_preset("Caterpillars Down", #preset_prkd20_brinstar_caterpillars_down)

presets_prkd20_brinstar_alpha_power_bombs:
    %cm_preset("Alpha Power Bombs", #preset_prkd20_brinstar_alpha_power_bombs)

presets_prkd20_brinstar_caterpillars_up:
    %cm_preset("Caterpillars Up", #preset_prkd20_brinstar_caterpillars_up)

presets_prkd20_brinstar_crateria_kihunters:
    %cm_preset("Crateria Kihunters", #preset_prkd20_brinstar_crateria_kihunters)

presets_prkd20_brinstar_continuous_wall_jump:
    %cm_preset("Continuous Wall Jump", #preset_prkd20_brinstar_continuous_wall_jump)

presets_prkd20_brinstar_horizontal_bomb_jump:
    %cm_preset("Horizontal Bomb Jump", #preset_prkd20_brinstar_horizontal_bomb_jump)

presets_prkd20_brinstar_ocean:
    %cm_preset("Ocean", #preset_prkd20_brinstar_ocean)


; Wrecked Ship
presets_prkd20_wrecked_ship_shaft_down:
    %cm_preset("Shaft Down", #preset_prkd20_wrecked_ship_shaft_down)

presets_prkd20_wrecked_ship_basement:
    %cm_preset("Basement", #preset_prkd20_wrecked_ship_basement)

presets_prkd20_wrecked_ship_phantoon:
    %cm_preset("Phantoon", #preset_prkd20_wrecked_ship_phantoon)

presets_prkd20_wrecked_ship_leaving_phantoon:
    %cm_preset("Leaving Phantoon", #preset_prkd20_wrecked_ship_leaving_phantoon)
...
presets_prkd20_wrecked_ship_shaft_up:
    %cm_preset("Shaft Up", #preset_prkd20_wrecked_ship_shaft_up)

presets_prkd20_wrecked_ship_attic:
    %cm_preset("Attic", #preset_prkd20_wrecked_ship_attic)

presets_prkd20_wrecked_ship_upper_west_ocean:
    %cm_preset("Upper West Ocean", #preset_prkd20_wrecked_ship_upper_west_ocean)

presets_prkd20_wrecked_ship_pancakes_and_wavers:
    %cm_preset("Pancakes and Wavers", #preset_prkd20_wrecked_ship_pancakes_and_wavers)

presets_prkd20_wrecked_ship_bowling_alley:
    %cm_preset("Bowling Alley", #preset_prkd20_wrecked_ship_bowling_alley)

presets_prkd20_wrecked_ship_leaving_gravity:
    %cm_preset("Leaving Gravity", #preset_prkd20_wrecked_ship_leaving_gravity)

presets_prkd20_wrecked_ship_reverse_moat:
    %cm_preset("Reverse Moat", #preset_prkd20_wrecked_ship_reverse_moat)

presets_prkd20_wrecked_ship_crateria_kihunters_return:
    %cm_preset("Crateria Kihunters Return", #preset_prkd20_wrecked_ship_crateria_kihunters_return)


; Red Brinstar Revisit
presets_prkd20_red_brinstar_revisit_red_brinstar_elevator:
    %cm_preset("Red Brinstar Elevator", #preset_prkd20_red_brinstar_revisit_red_brinstar_elevator)
...
presets_prkd20_red_brinstar_revisit_hellway_revisit:
    %cm_preset("Hellway Revisit", #preset_prkd20_red_brinstar_revisit_hellway_revisit)

presets_prkd20_red_brinstar_revisit_red_tower_down:
    %cm_preset("Red Tower Down", #preset_prkd20_red_brinstar_revisit_red_tower_down)

presets_prkd20_red_brinstar_revisit_skree_boost:
    %cm_preset("Skree Boost", #preset_prkd20_red_brinstar_revisit_skree_boost)

presets_prkd20_red_brinstar_revisit_below_spazer:
    %cm_preset("Below Spazer", #preset_prkd20_red_brinstar_revisit_below_spazer)
...
presets_prkd20_upper_norfair_ice_beam_gates:
    %cm_preset("Ice Beam Gates", #preset_prkd20_upper_norfair_ice_beam_gates)

presets_prkd20_upper_norfair_ice_maze_up:
    %cm_preset("Ice Maze Up", #preset_prkd20_upper_norfair_ice_maze_up)

presets_prkd20_upper_norfair_ice_maze_down:
    %cm_preset("Ice Maze Down", #preset_prkd20_upper_norfair_ice_maze_down)

presets_prkd20_upper_norfair_ice_escape:
    %cm_preset("Ice Escape", #preset_prkd20_upper_norfair_ice_escape)

presets_prkd20_upper_norfair_precathedral:
    %cm_preset("Pre-Cathedral", #preset_prkd20_upper_norfair_precathedral)

presets_prkd20_upper_norfair_cathedral:
    %cm_preset("Cathedral", #preset_prkd20_upper_norfair_cathedral)

presets_prkd20_upper_norfair_rising_tide:
    %cm_preset("Rising Tide", #preset_prkd20_upper_norfair_rising_tide)

presets_prkd20_upper_norfair_bubble_mountain:
    %cm_preset("Bubble Mountain", #preset_prkd20_upper_norfair_bubble_mountain)

presets_prkd20_upper_norfair_bat_cave:
    %cm_preset("Bat Cave", #preset_prkd20_upper_norfair_bat_cave)
...
presets_prkd20_upper_norfair_single_chamber:
    %cm_preset("Single Chamber", #preset_prkd20_upper_norfair_single_chamber)
...
presets_prkd20_upper_norfair_kronic_boost:
    %cm_preset("Kronic Boost", #preset_prkd20_upper_norfair_kronic_boost)

presets_prkd20_upper_norfair_lava_spark:
    %cm_preset("Lava Spark", #preset_prkd20_upper_norfair_lava_spark)


; Lower Norfair
presets_prkd20_lower_norfair_ln_main_hall:
    %cm_preset("LN Main Hall", #preset_prkd20_lower_norfair_ln_main_hall)
...
presets_prkd20_lower_norfair_kihunter_stairs_down:
    %cm_preset("Kihunter Stairs Down", #preset_prkd20_lower_norfair_kihunter_stairs_down)

presets_prkd20_lower_norfair_wasteland:
    %cm_preset("Wasteland", #preset_prkd20_lower_norfair_wasteland)

presets_prkd20_lower_norfair_metal_ninja_pirates:
    %cm_preset("Metal Ninja Pirates", #preset_prkd20_lower_norfair_metal_ninja_pirates)

presets_prkd20_lower_norfair_plowerhouse:
    %cm_preset("Plowerhouse", #preset_prkd20_lower_norfair_plowerhouse)

presets_prkd20_lower_norfair_ridley_farming_room:
    %cm_preset("Ridley Farming Room", #preset_prkd20_lower_norfair_ridley_farming_room)
...
presets_prkd20_lower_norfair_wasteland_revisit:
    %cm_preset("Wasteland Revisit", #preset_prkd20_lower_norfair_wasteland_revisit)
...
presets_prkd20_lower_norfair_three_musketeers:
    %cm_preset("Three Musketeers", #preset_prkd20_lower_norfair_three_musketeers)

presets_prkd20_lower_norfair_single_chamber_final:
    %cm_preset("Single Chamber Final", #preset_prkd20_lower_norfair_single_chamber_final)
...
presets_prkd20_lower_norfair_frog_speedway:
    %cm_preset("Frog Speedway", #preset_prkd20_lower_norfair_frog_speedway)
...
presets_prkd20_maridia_maridia_tube_revisit:
    %cm_preset("Maridia Tube Revisit", #preset_prkd20_maridia_maridia_tube_revisit)
...
presets_prkd20_maridia_aqueduct:
    %cm_preset("Aqueduct", #preset_prkd20_maridia_aqueduct)

presets_prkd20_maridia_botwoon_hallway:
    %cm_preset("Botwoon Hallway", #preset_prkd20_maridia_botwoon_hallway)

presets_prkd20_maridia_botwoon:
    %cm_preset("Botwoon", #preset_prkd20_maridia_botwoon)

presets_prkd20_maridia_botwoon_etank:
    %cm_preset("Botwoon E-Tank", #preset_prkd20_maridia_botwoon_etank)

presets_prkd20_maridia_halfie_setup:
    %cm_preset("Halfie Setup", #preset_prkd20_maridia_halfie_setup)

presets_prkd20_maridia_draygon:
    %cm_preset("Draygon", #preset_prkd20_maridia_draygon)

presets_prkd20_maridia_spikesuit_reverse_halfie:
    %cm_preset("Spikesuit Reverse Halfie", #preset_prkd20_maridia_spikesuit_reverse_halfie)

presets_prkd20_maridia_reverse_colosseum:
    %cm_preset("Reverse Colosseum", #preset_prkd20_maridia_reverse_colosseum)

presets_prkd20_maridia_reverse_halfie_climb:
    %cm_preset("Reverse Halfie Climb", #preset_prkd20_maridia_reverse_halfie_climb)

presets_prkd20_maridia_reverse_botwoon_etank:
    %cm_preset("Reverse Botwoon E-Tank", #preset_prkd20_maridia_reverse_botwoon_etank)

presets_prkd20_maridia_reverse_botwoon_hallway:
    %cm_preset("Reverse Botwoon Hallway", #preset_prkd20_maridia_reverse_botwoon_hallway)
...
presets_prkd20_backtracking_red_brinstar_green_gate:
    %cm_preset("Red Brinstar Green Gate", #preset_prkd20_backtracking_red_brinstar_green_gate)

presets_prkd20_backtracking_crateria_kihunters_final:
    %cm_preset("Crateria Kihunters Final", #preset_prkd20_backtracking_crateria_kihunters_final)

presets_prkd20_backtracking_parlor_return:
    %cm_preset("Parlor Return", #preset_prkd20_backtracking_parlor_return)

presets_prkd20_backtracking_terminator_revisit:
    %cm_preset("Terminator Revisit", #preset_prkd20_backtracking_terminator_revisit)
...
presets_prkd20_backtracking_g4_hallway:
    %cm_preset("G4 Hallway", #preset_prkd20_backtracking_g4_hallway)

presets_prkd20_backtracking_g4_elevator:
    %cm_preset("G4 Elevator", #preset_prkd20_backtracking_g4_elevator)


; Tourian
presets_prkd20_tourian_tourian_elevator_room:
    %cm_preset("Tourian Elevator Room", #preset_prkd20_tourian_tourian_elevator_room)

presets_prkd20_tourian_metroids_1:
    %cm_preset("Metroids 1", #preset_prkd20_tourian_metroids_1)

presets_prkd20_tourian_metroids_2:
    %cm_preset("Metroids 2", #preset_prkd20_tourian_metroids_2)

presets_prkd20_tourian_metroids_3:
    %cm_preset("Metroids 3", #preset_prkd20_tourian_metroids_3)

presets_prkd20_tourian_metroids_4:
    %cm_preset("Metroids 4", #preset_prkd20_tourian_metroids_4)

presets_prkd20_tourian_giant_hoppers:
    %cm_preset("Giant Hoppers", #preset_prkd20_tourian_giant_hoppers)

presets_prkd20_tourian_baby_skip:
    %cm_preset("Baby Skip", #preset_prkd20_tourian_baby_skip)

presets_prkd20_tourian_gadora_room:
    %cm_preset("Gadora Room", #preset_prkd20_tourian_gadora_room)

presets_prkd20_tourian_rinka_shaft:
    %cm_preset("Rinka Shaft", #preset_prkd20_tourian_rinka_shaft)

presets_prkd20_tourian_zeb_skip:
    %cm_preset("Zeb Skip", #preset_prkd20_tourian_zeb_skip)

presets_prkd20_tourian_mother_brain_2:
    %cm_preset("Mother Brain 2", #preset_prkd20_tourian_mother_brain_2)

presets_prkd20_tourian_mother_brain_3:
    %cm_preset("Mother Brain 3", #preset_prkd20_tourian_mother_brain_3)

presets_prkd20_tourian_zebes_escape:
    %cm_preset("Zebes Escape", #preset_prkd20_tourian_zebes_escape)

presets_prkd20_tourian_escape_room_3:
    %cm_preset("Escape Room 3", #preset_prkd20_tourian_escape_room_3)

presets_prkd20_tourian_escape_room_4:
    %cm_preset("Escape Room 4", #preset_prkd20_tourian_escape_room_4)

presets_prkd20_tourian_escape_climb:
    %cm_preset("Escape Climb", #preset_prkd20_tourian_escape_climb)
