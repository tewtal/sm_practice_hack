...
presets_kpdr22_kraid_minikraid:
    %cm_preset("Mini-Kraid", #preset_kpdr22_kraid_minikraid)
...
presets_kpdr22_kraid_minikraid_revisit:
    %cm_preset("Mini-Kraid Revisit", #preset_kpdr22_kraid_minikraid_revisit)
...
presets_kpdr22_upper_norfair_hijump_etank:
    %cm_preset("Hi-Jump E-Tank", #preset_kpdr22_upper_norfair_hijump_etank)

presets_kpdr22_upper_norfair_leaving_hijump:
    %cm_preset("Leaving Hi-Jump", #preset_kpdr22_upper_norfair_leaving_hijump)
...
presets_kpdr22_lower_norfair_fast_pillars_setup:
    %cm_preset("Fast Pillars Setup", #preset_kpdr22_lower_norfair_fast_pillars_setup)
...
presets_kpdr22_lower_norfair_fireflea_room:
    %cm_preset("Fireflea Room", #preset_kpdr22_lower_norfair_fireflea_room)
