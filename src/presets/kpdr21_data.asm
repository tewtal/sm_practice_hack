...
preset_kpdr21_kraid_warehouse_zeelas:
    dw #preset_kpdr21_kraid_entering_kraids_lair ; Kraid: Entering Kraids Lair
    dw $078D, $A384  ; DDB
    dw $079B, $A6A1  ; MDB
    dw $07F5, $0003  ; Music Track
    dw $090F, $C000  ; Screen subpixel X position
...
preset_kpdr21_kraid_fallen_hero:
    dw #preset_kpdr21_kraid_mini_kraid ; Kraid: Mini Kraid
    dw $078D, $917A  ; DDB
    dw $079B, $A521  ; MDB
...
preset_kpdr21_kraid_kraid_kihunters_revisit:
    dw #preset_kpdr21_kraid_mini_kraid_revisit ; Kraid: Mini Kraid Revisit
    dw $078D, $91AA  ; DDB
    dw $079B, $A521  ; MDB
...
preset_kpdr21_maridia_fish_tank:
    dw #preset_kpdr21_red_brinstar_revisit_breaking_tube ; Red Brinstar Revisit: Breaking Tube
    dw $078D, $A330  ; DDB
    dw $079B, $CFC9  ; MDB
