...
preset_kpdr21_kraid_entering_kraids_lair:
    dw #preset_kpdr21_brinstar_passing_through_maridia ; Brinstar: Passing Through Maridia
    dw $078D, $A348  ; DDB
    dw $079B, $CF80  ; MDB
    dw $090F, $4000  ; Screen subpixel X position
    dw $0911, $0000  ; Screen X position in pixels
...
preset_kpdr21_kraid_warehouse_zeelas:
    dw #preset_kpdr21_kraid_entering_kraids_lair ; Kraid: Entering Kraid's Lair
    dw $078D, $A384  ; DDB
    dw $079B, $A6A1  ; MDB
    dw $07F5, $0003  ; Music Track
    dw $090F, $C000  ; Screen subpixel X position
...
preset_kpdr21_kraid_kraid_kihunters:
    dw #preset_kpdr21_kraid_warehouse_zeelas ; Kraid: Warehouse Zeelas
    dw $078D, $923A  ; DDB
    dw $079B, $A471  ; MDB
    dw $07F5, $0005  ; Music Track
    dw $090F, $8000  ; Screen subpixel X position
...
preset_kpdr21_kraid_minikraid:
    dw #preset_kpdr21_kraid_kraid_kihunters ; Kraid: Kraid Kihunters
    dw $078D, $9156  ; DDB
    dw $079B, $A4DA  ; MDB
...
preset_kpdr21_kraid_fallen_hero:
    dw #preset_kpdr21_kraid_minikraid ; Kraid: Mini-Kraid
    dw $078D, $917A  ; DDB
    dw $079B, $A521  ; MDB
...
preset_kpdr21_kraid_kraid:
    dw #preset_kpdr21_kraid_fallen_hero ; Kraid: Fallen Hero
    dw $078D, $919E  ; DDB
    dw $079B, $A56B  ; MDB
...
preset_kpdr21_kraid_leaving_varia:
    dw #preset_kpdr21_kraid_kraid ; Kraid: Kraid
    dw $078D, $91DA  ; DDB
    dw $079B, $A6E2  ; MDB
    dw $07F5, $0003  ; Music Track
...
preset_kpdr21_kraid_arthur_j_metroid:
    dw #preset_kpdr21_kraid_leaving_varia ; Kraid: Leaving Varia
    dw $078D, $9252  ; DDB
    dw $079B, $A59F  ; MDB
...
preset_kpdr21_kraid_minikraid_revisit:
    dw #preset_kpdr21_kraid_arthur_j_metroid ; Kraid: Arthur J. Metroid
    dw $078D, $91CE  ; DDB
    dw $079B, $A56B  ; MDB
    dw $090F, $3000  ; Screen subpixel X position
...
preset_kpdr21_kraid_kraid_kihunters_revisit:
    dw #preset_kpdr21_kraid_minikraid_revisit ; Kraid: Mini-Kraid Revisit
    dw $078D, $91AA  ; DDB
    dw $079B, $A521  ; MDB
...
preset_kpdr21_kraid_kraid_etank:
    dw #preset_kpdr21_kraid_kraid_kihunters_revisit ; Kraid: Kraid Kihunters Revisit
    dw $078D, $916E  ; DDB
    dw $079B, $A471  ; MDB
    dw $07F3, $0012  ; Music Bank
    dw $07F5, $0005  ; Music Track
...
preset_kpdr21_kraid_business_center_preelev:
    dw #preset_kpdr21_kraid_kraid_etank ; Kraid: Kraid E-Tank
    dw $078D, $913E  ; DDB
    dw $079B, $A6A1  ; MDB
    dw $07F5, $0003  ; Music Track
    dw $090F, $3000  ; Screen subpixel X position
...
preset_kpdr21_upper_norfair_business_center_postelev:
    dw #preset_kpdr21_kraid_business_center_preelev ; Kraid: Business Center Pre-Elev
    dw $078D, $9246  ; DDB
    dw $079B, $A7DE  ; MDB
...
preset_kpdr21_upper_norfair_hijump_etank:
    dw #preset_kpdr21_upper_norfair_business_center_postelev ; Upper Norfair: Business Center Post-Elev
...
preset_kpdr21_upper_norfair_leaving_hijump:
    dw #preset_kpdr21_upper_norfair_hijump_etank ; Upper Norfair: Hi-Jump E-Tank
    dw $078D, $9426  ; DDB
    dw $079B, $A9E5  ; MDB
    dw $07F5, $0003  ; Music Track
...
preset_kpdr21_upper_norfair_business_center_revisit:
    dw #preset_kpdr21_upper_norfair_leaving_hijump ; Upper Norfair: Leaving Hi-Jump
    dw $078D, $93F6  ; DDB
    dw $079B, $AA41  ; MDB
    dw $07F5, $0005  ; Music Track
    dw $090F, $4000  ; Screen subpixel X position
...
preset_kpdr21_upper_norfair_bat_cave_revisit:
    dw #preset_kpdr21_upper_norfair_speed_hallway ; Upper Norfair: Speed Hallway
    dw $078D, $95BE  ; DDB
    dw $079B, $ACF0  ; MDB
    dw $090F, $C000  ; Screen subpixel X position
    dw $0913, $0000  ; Screen subpixel Y position
...
preset_kpdr21_upper_norfair_single_chamber:
    dw #preset_kpdr21_upper_norfair_bat_cave_revisit ; Upper Norfair: Bat Cave Revisit
    dw $078D, $97AA  ; DDB
    dw $079B, $ACB3  ; MDB
...
preset_kpdr21_red_brinstar_alpha_spark:
    dw #preset_kpdr21_upper_norfair_heading_to_red_brinstar ; Upper Norfair: Heading To Red Brinstar
    dw $078D, $92EE  ; DDB
    dw $079B, $A6A1  ; MDB
    dw $07F3, $0012  ; Music Bank
    dw $07F5, $0003  ; Music Track
...
preset_kpdr21_wrecked_ship_ocean_spark:
    dw #preset_kpdr21_wrecked_ship_ocean_fly_setup ; Wrecked Ship: Ocean Fly Setup
    dw $078D, $8A36  ; DDB
    dw $079B, $95FF  ; MDB
...
preset_kpdr21_red_brinstar_revisit_caterpillars_revisit:
    dw #preset_kpdr21_red_brinstar_revisit_red_brinstar_elevator ; Red Brinstar Revisit: Red Brinstar Elevator
    dw $078D, $8B02  ; DDB
    dw $079B, $A322  ; MDB
    dw $07F3, $0012  ; Music Bank
    dw $07F5, $0005  ; Music Track
...
preset_kpdr21_red_brinstar_revisit_hellway_revisit:
    dw #preset_kpdr21_red_brinstar_revisit_caterpillars_revisit ; Red Brinstar Revisit: Caterpillars Revisit
    dw $090F, $C000  ; Screen subpixel X position
    dw $0913, $2800  ; Screen subpixel Y position
...
preset_kpdr21_red_brinstar_revisit_red_tower_down:
    dw #preset_kpdr21_red_brinstar_revisit_hellway_revisit ; Red Brinstar Revisit: Hellway Revisit
    dw $078D, $90AE  ; DDB
    dw $079B, $A2F7  ; MDB
...
preset_kpdr21_red_brinstar_revisit_skree_boost_final:
    dw #preset_kpdr21_red_brinstar_revisit_red_tower_down ; Red Brinstar Revisit: Red Tower Down
    dw $078D, $907E  ; DDB
    dw $079B, $A253  ; MDB
...
preset_kpdr21_red_brinstar_revisit_below_spazer_final:
    dw #preset_kpdr21_red_brinstar_revisit_skree_boost_final ; Red Brinstar Revisit: Skree Boost Final
    dw $078D, $9042  ; DDB
    dw $079B, $A3DD  ; MDB
...
preset_kpdr21_red_brinstar_revisit_breaking_the_tube:
    dw #preset_kpdr21_red_brinstar_revisit_below_spazer_final ; Red Brinstar Revisit: Below Spazer Final
    dw $078D, $9102  ; DDB
    dw $079B, $A408  ; MDB
    dw $090F, $C000  ; Screen subpixel X position
    dw $0913, $D000  ; Screen subpixel Y position
...
preset_kpdr21_maridia_fish_tank:
    dw #preset_kpdr21_red_brinstar_revisit_breaking_the_tube ; Red Brinstar Revisit: Breaking The Tube
    dw $078D, $A330  ; DDB
    dw $079B, $CFC9  ; MDB
...
preset_kpdr21_maridia_cac_alley_east:
    dw #preset_kpdr21_maridia_whomple_jump ; Maridia: Whomple Jump
    dw $078D, $A7E0  ; DDB
    dw $079B, $D913  ; MDB
    dw $090F, $8000  ; Screen subpixel X position
...
preset_kpdr21_lower_norfair_springball_maze:
    dw #preset_kpdr21_lower_norfair_fireflea_room ; Lower Norfair: Fireflea Room
    dw $078D, $9A02  ; DDB
    dw $079B, $B6EE  ; MDB
    dw $090F, $0000  ; Screen subpixel X position
    dw $0911, $0100  ; Screen X position in pixels
...
preset_kpdr21_backtracking_red_brinstar_green_gate:
    dw #preset_kpdr21_backtracking_mt_everest_revisit ; Backtracking: Mt. Everest Revisit
    dw $078D, $A42C  ; DDB
    dw $079B, $D104  ; MDB
...
preset_kpdr21_backtracking_g4_elevator:
    dw #preset_kpdr21_backtracking_g4_hallway ; Backtracking: G4 Hallway
    dw $078D, $91F2  ; DDB
    dw $079B, $A66A  ; MDB
    dw $07F5, $0006  ; Music Track
    dw $090F, $7000  ; Screen subpixel X position
...
preset_kpdr21_tourian_tourian_elevator_room:
    dw #preset_kpdr21_backtracking_g4_elevator ; Backtracking: G4 Elevator
    dw $078D, $9222  ; DDB
    dw $079B, $DAAE  ; MDB
...
preset_kpdr21_tourian_metroids_1:
    dw #preset_kpdr21_tourian_tourian_elevator_room ; Tourian: Tourian Elevator Room
    dw $090F, $8000  ; Screen subpixel X position
