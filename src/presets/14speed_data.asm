...
preset_14speed_crateria_ship:
    ...
    dl $7E0917 : db $02 : dw $01FD ; Layer 2 X scroll in room in pixels?
...
preset_14speed_crateria_morph:
    ...
    dl $7E0917 : db $02 : dw $03BC ; Layer 2 X scroll in room in pixels?
...
preset_14speed_wrecked_ship_wrecked_ship_shaft:
    ...
    dl $7E0917 : db $02 : dw $0222 ; Layer 2 X scroll in room in pixels?
    dl $7E09CA : db $02 : dw $0004 ; Supers
...
preset_14speed_wrecked_ship_wrecked_ship_supers:
    ...
    dl $7E0917 : db $02 : dw $019E ; Layer 2 X scroll in room in pixels?
    dl $7E0921 : db $02 : dw $FB00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dl $7E09C2 : db $02 : dw $00C7 ; Health
...
preset_14speed_upper_norfair_bubble_mountain_revisit:
    ...
    dl $7ED8BA : db $02 : dw $0030 ; Events, Items, Doors
...
preset_14speed_upper_norfair_lava_spark:
    ...
    dl $7ED8BA : db $02 : dw $0130 ; Events, Items, Doors
    dw #$FFFF
.after
...
preset_14speed_lower_norfair_kihunter_stairs:
    ...
    dl $7E0917 : db $02 : dw $01B3 ; Layer 2 X scroll in room in pixels?
...
preset_14speed_lower_norfair_wasteland:
    ...
    dl $7ED8BA : db $02 : dw $4130 ; Events, Items, Doors
    dw #$FFFF
.after
...
preset_14speed_lower_norfair_metal_pirates:
    ...
    dl $7E0AFA : db $02 : dw $028B ; Samus Y
    dl $7ED8BA : db $02 : dw $C130 ; Events, Items, Doors
...
preset_14speed_lower_norfair_ridley:
    ...
    dl $7ED8BA : db $02 : dw $D130 ; Events, Items, Doors
    dw #$FFFF
.after
...
preset_14speed_lower_norfair_leaving_ridley:
    ...
    dl $7ED878 : db $02 : dw $4004 ; Events, Items, Doors
    dl $7ED8BA : db $02 : dw $D930 ; Events, Items, Doors
...
preset_14speed_lower_norfair_wasteland_revisit:
    ...
    dl $7E0AF6 : db $02 : dw $02DB ; Samus X
    dl $7E0AFA : db $02 : dw $00AB ; Samus Y
    dl $7ED8BA : db $02 : dw $DD30 ; Events, Items, Doors
    dw #$FFFF
.after
...
preset_14speed_maridia_everest_revisit:
    ...
    dl $7E0919 : db $02 : dw $0185 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dl $7E0921 : db $02 : dw $FE00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dl $7E0923 : db $02 : dw $FD00 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
...
preset_14speed_maridia_red_tower_green_gate:
    ...
    dl $7E0913 : db $02 : dw $CC00 ; Screen subpixel Y position
    dl $7E0915 : db $02 : dw $0000 ; Screen Y position in pixels
    dl $7E0917 : db $02 : dw $0013 ; Layer 2 X scroll in room in pixels?
    dl $7E0919 : db $02 : dw $0000 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dl $7E0923 : db $02 : dw $FE00 ; BG2 Y scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
...
preset_14speed_tourian_metroids_3:
    ...
    dl $7E0919 : db $02 : dw $00B8 ; Layer 2 Y scroll in room in pixels? (up = positive)
    dl $7E0921 : db $02 : dw $FF00 ; BG2 X scroll offset due to room transitions (Translates between Layer 2 scroll and BG2 scroll)
    dl $7E09C2 : db $02 : dw $015E ; Health
    dl $7E09CE : db $02 : dw $0003 ; Pbs
    dl $7E0A1C : db $02 : dw $0001 ; Samus position/state
