...
preset_allbossprkd_kraids_lair_baby_kraid_entering_2:
    ...
    dl $7ED876 : db $02 : dw $0135 ; Items
    dl $7ED8B8 : db $02 : dw $EEE4 ; Doors
    dw #$FFFF
.after
