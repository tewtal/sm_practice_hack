...
presets_submenu_rbo_brinstar_cleanup:
    ...
    dw #presets_rbo_brinstar_cleanup_red_tower_up
...
presets_submenu_rbo_norfair_escape:
    ...
    dw #presets_rbo_norfair_escape_3_muskateers_exit
...
presets_submenu_rbo_kraidg4:
    ...
    dw #presets_rbo_kraidg4_red_tower_up_2
...
presets_rbo_brinstar_cleanup_red_tower_up:
    %cm_preset("Red Tower (Up)", #preset_rbo_brinstar_cleanup_red_tower_up)
...
presets_rbo_brinstar_cleanup_dachora_room_2:
    %cm_preset("Dachora Room", #preset_rbo_brinstar_cleanup_dachora_room_2)
...
presets_rbo_norfair_escape_3_muskateers_exit:
    %cm_preset("3 Muskateers Exit", #preset_rbo_norfair_escape_3_muskateers_exit)
...
presets_rbo_kraidg4_red_tower_up_2:
    %cm_preset("Red Tower (Up)", #preset_rbo_kraidg4_red_tower_up_2)
