...
presets_allbosspkdr_wrecked_ship_breaking_the_tube:
    %cm_preset("Breaking The Tube", #preset_allbosspkdr_wrecked_ship_breaking_the_tube)
...
presets_allbosspkdr_upper_norfair_hijump_etank:
    %cm_preset("Hi-Jump E-Tank", #preset_allbosspkdr_upper_norfair_hijump_etank)

presets_allbosspkdr_upper_norfair_leaving_hijump:
    %cm_preset("Leaving Hi-Jump", #preset_allbosspkdr_upper_norfair_leaving_hijump)
...
presets_allbosspkdr_kraids_lair_minikraid:
    %cm_preset("Mini-Kraid", #preset_allbosspkdr_kraids_lair_minikraid)
...
presets_allbosspkdr_kraids_lair_minikraid_revisit:
    %cm_preset("Mini-Kraid Revisit", #preset_allbosspkdr_kraids_lair_minikraid_revisit)
...
presets_allbosspkdr_lower_norfair_fireflea_room:
    %cm_preset("Fireflea Room", #preset_allbosspkdr_lower_norfair_fireflea_room)
...
presets_allbosspkdr_spore_spawn_red_tower:
    %cm_preset("Red Tower", #preset_allbosspkdr_spore_spawn_red_tower)
...
presets_allbosspkdr_spore_spawn_spore_spawn:
    %cm_preset("Spore Spawn", #preset_allbosspkdr_spore_spawn_spore_spawn)
