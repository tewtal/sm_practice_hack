...
presets_submenu_allbosspkdr_wrecked_ship:
    ...
    dw #presets_allbosspkdr_wrecked_ship_breaking_the_tube
    dw #$0000
    %cm_header("WRECKED SHIP")

presets_submenu_allbosspkdr_upper_norfair:
    dw #presets_allbosspkdr_upper_norfair_business_center
    dw #presets_allbosspkdr_upper_norfair_hijump_etank
    dw #presets_allbosspkdr_upper_norfair_leaving_hijump
...
presets_submenu_allbosspkdr_kraids_lair:
    ...
    dw #presets_allbosspkdr_kraids_lair_minikraid
...
presets_allbosspkdr_crateria_ceres_elevator:
    %cm_preset("Ceres Elevator", #preset_names_ceres_elevator, #preset_allbosspkdr_crateria_ceres_elevator)

presets_allbosspkdr_crateria_ceres_escape:
    %cm_preset("Ceres Escape", #preset_names_ceres_escape, #preset_allbosspkdr_crateria_ceres_escape)

presets_allbosspkdr_crateria_ceres_last_3_rooms:
    %cm_preset("Ceres Last 3 Rooms", #preset_names_ceres_last_3_rooms, #preset_allbosspkdr_crateria_ceres_last_3_rooms)

presets_allbosspkdr_crateria_ship:
    %cm_preset("Ship", #preset_names_ship, #preset_allbosspkdr_crateria_ship)

presets_allbosspkdr_crateria_pit_room:
    %cm_preset("Pit Room", #preset_names_pit_room, #preset_allbosspkdr_crateria_pit_room)

presets_allbosspkdr_crateria_morph:
    %cm_preset("Morph", #preset_names_morph, #preset_allbosspkdr_crateria_morph)

presets_allbosspkdr_crateria_pit_room_revisit:
    %cm_preset("Pit Room Revisit", #preset_names_pit_room_revisit, #preset_allbosspkdr_crateria_pit_room_revisit)

presets_allbosspkdr_crateria_climb:
    %cm_preset("Climb", #preset_names_climb, #preset_allbosspkdr_crateria_climb)
...
presets_allbosspkdr_crateria_bomb_torizo:
    %cm_preset("Bomb Torizo", #preset_names_bomb_torizo, #preset_allbosspkdr_crateria_bomb_torizo)

presets_allbosspkdr_crateria_terminator:
    %cm_preset("Terminator", #preset_names_terminator, #preset_allbosspkdr_crateria_terminator)

presets_allbosspkdr_crateria_green_pirate_shaft:
    %cm_preset("Green Pirate Shaft", #preset_names_green_pirate_shaft, #preset_allbosspkdr_crateria_green_pirate_shaft)


; Brinstar
presets_allbosspkdr_brinstar_green_brinstar_elevator:
    %cm_preset("Green Brinstar Elevator", #preset_names_green_brinstar_elevator, #preset_allbosspkdr_brinstar_green_brinstar_elevator)

presets_allbosspkdr_brinstar_dachora_room:
    %cm_preset("Dachora Room", #preset_names_dachora_room, #preset_allbosspkdr_brinstar_dachora_room)

presets_allbosspkdr_brinstar_big_pink:
    %cm_preset("Big Pink", #preset_names_big_pink, #preset_allbosspkdr_brinstar_big_pink)

presets_allbosspkdr_brinstar_red_tower:
    %cm_preset("Red Tower", #preset_names_red_tower, #preset_allbosspkdr_brinstar_red_tower)

presets_allbosspkdr_brinstar_hellway:
    %cm_preset("Hellway", #preset_names_hellway, #preset_allbosspkdr_brinstar_hellway)

presets_allbosspkdr_brinstar_leaving_power_bombs:
    %cm_preset("Leaving Power Bombs", #preset_names_leaving_power_bombs, #preset_allbosspkdr_brinstar_leaving_power_bombs)

presets_allbosspkdr_brinstar_crateria_elevator:
    %cm_preset("Crateria Elevator", #preset_names_crateria_elevator, #preset_allbosspkdr_brinstar_crateria_elevator)

presets_allbosspkdr_brinstar_moat:
    %cm_preset("Moat", #preset_names_moat, #preset_allbosspkdr_brinstar_moat)

presets_allbosspkdr_brinstar_ocean:
    %cm_preset("Ocean", #preset_names_ocean, #preset_allbosspkdr_brinstar_ocean)


; Wrecked Ship
presets_allbosspkdr_wrecked_ship_entering_wrecked_ship:
    %cm_preset("Entering Wrecked Ship", #preset_names_entering_wrecked_ship, #preset_allbosspkdr_wrecked_ship_entering_wrecked_ship)

presets_allbosspkdr_wrecked_ship_phantoon:
    %cm_preset("Phantoon", #preset_names_phantoon, #preset_allbosspkdr_wrecked_ship_phantoon)

presets_allbosspkdr_wrecked_ship_leaving_phantoon:
    %cm_preset("Leaving Phantoon", #preset_names_leaving_phantoon, #preset_allbosspkdr_wrecked_ship_leaving_phantoon)

presets_allbosspkdr_wrecked_ship_wrecked_ship_shaft:
    %cm_preset("Wrecked Ship Shaft", #preset_names_wrecked_ship_shaft, #preset_allbosspkdr_wrecked_ship_wrecked_ship_shaft)

presets_allbosspkdr_wrecked_ship_attic:
    %cm_preset("Attic", #preset_names_attic, #preset_allbosspkdr_wrecked_ship_attic)

presets_allbosspkdr_wrecked_ship_bowling_spark:
    %cm_preset("Bowling Spark", #preset_names_bowling_spark, #preset_allbosspkdr_wrecked_ship_bowling_spark)

presets_allbosspkdr_wrecked_ship_leaving_gravity:
    %cm_preset("Leaving Gravity", #preset_names_leaving_gravity, #preset_allbosspkdr_wrecked_ship_leaving_gravity)

presets_allbosspkdr_wrecked_ship_red_tower_elevator:
    %cm_preset("Red Tower Elevator", #preset_names_red_tower_elevator, #preset_allbosspkdr_wrecked_ship_red_tower_elevator)

presets_allbosspkdr_wrecked_ship_red_tower_descent:
    %cm_preset("Red Tower Descent", #preset_names_red_tower_descent, #preset_allbosspkdr_wrecked_ship_red_tower_descent)

presets_allbosspkdr_wrecked_ship_breaking_the_tube:
    %cm_preset("Breaking The Tube", #preset_names_breaking_the_tube, #preset_allbosspkdr_wrecked_ship_breaking_the_tube)


; Upper Norfair
presets_allbosspkdr_upper_norfair_business_center:
    %cm_preset("Business Center", #preset_names_business_center, #preset_allbosspkdr_upper_norfair_business_center)

presets_allbosspkdr_upper_norfair_hijump_etank:
    %cm_preset("Hi-Jump E-Tank", #preset_names_hijump_etank, #preset_allbosspkdr_upper_norfair_hijump_etank)

presets_allbosspkdr_upper_norfair_leaving_hijump:
    %cm_preset("Leaving Hi-Jump", #preset_names_leaving_hijump, #preset_allbosspkdr_upper_norfair_leaving_hijump)
...
presets_allbosspkdr_upper_norfair_bubble_mountain:
    %cm_preset("Bubble Mountain", #preset_names_bubble_mountain, #preset_allbosspkdr_upper_norfair_bubble_mountain)

presets_allbosspkdr_upper_norfair_single_chamber:
    %cm_preset("Single Chamber", #preset_names_single_chamber, #preset_allbosspkdr_upper_norfair_single_chamber)
...
presets_allbosspkdr_upper_norfair_business_center_revisit:
    %cm_preset("Business Center Revisit", #preset_names_business_center_revisit, #preset_allbosspkdr_upper_norfair_business_center_revisit)


; Kraid's Lair
presets_allbosspkdr_kraids_lair_entering_kraids_lair:
    %cm_preset("Entering Kraid's Lair", #preset_names_entering_kraids_lair, #preset_allbosspkdr_kraids_lair_entering_kraids_lair)

presets_allbosspkdr_kraids_lair_minikraid:
    %cm_preset("Mini-Kraid", #preset_names_minikraid, #preset_allbosspkdr_kraids_lair_minikraid)

presets_allbosspkdr_kraids_lair_kraid:
    %cm_preset("Kraid", #preset_names_kraid, #preset_allbosspkdr_kraids_lair_kraid)

presets_allbosspkdr_kraids_lair_minikraid_revisit:
    %cm_preset("Mini-Kraid Revisit", #preset_names_minikraid_revisit, #preset_allbosspkdr_kraids_lair_minikraid_revisit)

presets_allbosspkdr_kraids_lair_leaving_kraids_lair:
    %cm_preset("Leaving Kraid's Lair", #preset_names_leaving_kraids_lair, #preset_allbosspkdr_kraids_lair_leaving_kraids_lair)


; Maridia
presets_allbosspkdr_maridia_mt_everest:
    %cm_preset("Mt. Everest", #preset_names_mt_everest, #preset_allbosspkdr_maridia_mt_everest)

presets_allbosspkdr_maridia_botwoon:
    %cm_preset("Botwoon", #preset_names_botwoon, #preset_allbosspkdr_maridia_botwoon)

presets_allbosspkdr_maridia_halfie:
    %cm_preset("Halfie", #preset_names_halfie, #preset_allbosspkdr_maridia_halfie)

presets_allbosspkdr_maridia_draygon:
    %cm_preset("Draygon", #preset_names_draygon, #preset_allbosspkdr_maridia_draygon)

presets_allbosspkdr_maridia_whomple_jump:
    %cm_preset("Whomple Jump", #preset_names_whomple_jump, #preset_allbosspkdr_maridia_whomple_jump)

presets_allbosspkdr_maridia_cac_alley:
    %cm_preset("Cac Alley", #preset_names_cac_alley, #preset_allbosspkdr_maridia_cac_alley)

presets_allbosspkdr_maridia_plasma_spark:
    %cm_preset("Plasma Spark", #preset_names_plasma_spark, #preset_allbosspkdr_maridia_plasma_spark)

presets_allbosspkdr_maridia_plasma_beam:
    %cm_preset("Plasma Beam", #preset_names_plasma_beam, #preset_allbosspkdr_maridia_plasma_beam)

presets_allbosspkdr_maridia_plasma_spark_revisit:
    %cm_preset("Plasma Spark Revisit", #preset_names_plasma_spark_revisit, #preset_allbosspkdr_maridia_plasma_spark_revisit)

presets_allbosspkdr_maridia_sewers:
    %cm_preset("Sewers", #preset_names_sewers, #preset_allbosspkdr_maridia_sewers)
...
presets_allbosspkdr_upper_norfair_revisit_ice_escape:
    %cm_preset("Ice Escape", #preset_names_ice_escape, #preset_allbosspkdr_upper_norfair_revisit_ice_escape)
...
presets_allbosspkdr_upper_norfair_revisit_crocomire:
    %cm_preset("Crocomire", #preset_names_crocomire, #preset_allbosspkdr_upper_norfair_revisit_crocomire)
...
presets_allbosspkdr_upper_norfair_revisit_kronic_boost:
    %cm_preset("Kronic Boost", #preset_names_kronic_boost, #preset_allbosspkdr_upper_norfair_revisit_kronic_boost)


; Lower Norfair
presets_allbosspkdr_lower_norfair_ln_main_hall:
    %cm_preset("LN Main Hall", #preset_names_ln_main_hall, #preset_allbosspkdr_lower_norfair_ln_main_hall)
...
presets_allbosspkdr_lower_norfair_golden_torizo:
    %cm_preset("Golden Torizo", #preset_names_golden_torizo, #preset_allbosspkdr_lower_norfair_golden_torizo)

presets_allbosspkdr_lower_norfair_screw_attack_escape:
    %cm_preset("Screw Attack Escape", #preset_names_screw_attack_escape, #preset_allbosspkdr_lower_norfair_screw_attack_escape)
...
presets_allbosspkdr_lower_norfair_metal_pirates:
    %cm_preset("Metal Pirates", #preset_names_metal_pirates, #preset_allbosspkdr_lower_norfair_metal_pirates)

presets_allbosspkdr_lower_norfair_ridley:
    %cm_preset("Ridley", #preset_names_ridley, #preset_allbosspkdr_lower_norfair_ridley)

presets_allbosspkdr_lower_norfair_leaving_ridley:
    %cm_preset("Leaving Ridley", #preset_names_leaving_ridley, #preset_allbosspkdr_lower_norfair_leaving_ridley)

presets_allbosspkdr_lower_norfair_wasteland_revisit:
    %cm_preset("Wasteland Revisit", #preset_names_wasteland_revisit, #preset_allbosspkdr_lower_norfair_wasteland_revisit)

presets_allbosspkdr_lower_norfair_fireflea_room:
    %cm_preset("Fireflea Room", #preset_names_fireflea_room, #preset_allbosspkdr_lower_norfair_fireflea_room)

presets_allbosspkdr_lower_norfair_three_musketeers:
    %cm_preset("Three Musketeers", #preset_names_three_musketeers, #preset_allbosspkdr_lower_norfair_three_musketeers)

presets_allbosspkdr_lower_norfair_bubble_mountain_final:
    %cm_preset("Bubble Mountain Final", #preset_names_bubble_mountain_final, #preset_allbosspkdr_lower_norfair_bubble_mountain_final)


; Spore Spawn
presets_allbosspkdr_spore_spawn_maridia_passthrough:
    %cm_preset("Maridia Passthrough", #preset_names_maridia_passthrough, #preset_allbosspkdr_spore_spawn_maridia_passthrough)

presets_allbosspkdr_spore_spawn_red_tower:
    %cm_preset("Red Tower", #preset_names_red_tower, #preset_allbosspkdr_spore_spawn_red_tower)

presets_allbosspkdr_spore_spawn_lower_green_brinstar:
    %cm_preset("Lower Green Brinstar", #preset_names_lower_green_brinstar, #preset_allbosspkdr_spore_spawn_lower_green_brinstar)

presets_allbosspkdr_spore_spawn_big_pink_up:
    %cm_preset("Big Pink Up", #preset_names_big_pink_up, #preset_allbosspkdr_spore_spawn_big_pink_up)

presets_allbosspkdr_spore_spawn_spore_spawn:
    %cm_preset("Spore Spawn", #preset_names_spore_spawn, #preset_allbosspkdr_spore_spawn_spore_spawn)

presets_allbosspkdr_spore_spawn_big_pink_down:
    %cm_preset("Big Pink Down", #preset_names_big_pink_down, #preset_allbosspkdr_spore_spawn_big_pink_down)

presets_allbosspkdr_spore_spawn_dachora_room_revisit:
    %cm_preset("Dachora Room Revisit", #preset_names_dachora_room_revisit, #preset_allbosspkdr_spore_spawn_dachora_room_revisit)
...
presets_allbosspkdr_tourian_metroids_1:
    %cm_preset("Metroids 1", #preset_names_metroids_1, #preset_allbosspkdr_tourian_metroids_1)

presets_allbosspkdr_tourian_metroids_2:
    %cm_preset("Metroids 2", #preset_names_metroids_2, #preset_allbosspkdr_tourian_metroids_2)

presets_allbosspkdr_tourian_metroids_3:
    %cm_preset("Metroids 3", #preset_names_metroids_3, #preset_allbosspkdr_tourian_metroids_3)

presets_allbosspkdr_tourian_metroids_4:
    %cm_preset("Metroids 4", #preset_names_metroids_4, #preset_allbosspkdr_tourian_metroids_4)

presets_allbosspkdr_tourian_baby_skip:
    %cm_preset("Baby Skip", #preset_names_baby_skip, #preset_allbosspkdr_tourian_baby_skip)

presets_allbosspkdr_tourian_zeb_skip:
    %cm_preset("Zeb Skip", #preset_names_zeb_skip, #preset_allbosspkdr_tourian_zeb_skip)

presets_allbosspkdr_tourian_escape_room_3:
    %cm_preset("Escape Room 3", #preset_names_escape_room_3, #preset_allbosspkdr_tourian_escape_room_3)

presets_allbosspkdr_tourian_escape_parlor:
    %cm_preset("Escape Parlor", #preset_names_escape_parlor, #preset_allbosspkdr_tourian_escape_parlor)
