...
!ram_drop_chance_table              = !WRAM_PERSIST_START+$38
...
!ram_cm_aim_anywhere = !WRAM_MENU_START+$94
...
!ram_cm_noncustompalette = !WRAM_MENU_START+$98
...
!sram_safeties_kpdr20 = !SRAM_START+$B4
!sram_safeties_kpdr25 = !SRAM_START+$B6
...
!CTRL_ANY = #$FFF0
!CTRL_ABLRXY_SELECT = #$E0F0
!CTRL_ABXY_SELECT = #$E0C0
!CTRL_AB = #$8080
!CTRL_B = #$8000
!CTRL_Y = #$4000
!CTRL_SELECT = #$2000
...
!SAMUS_BOMB_X_SUBPX = $0B96
!SAMUS_PROJ_Y_SUBPX = $0BA0
!SAMUS_BOMB_Y_SUBPX = $0BAA
!SAMUS_PROJ_RADIUS_X = $0BB4
!SAMUS_BOMB_RADIUS_X = $0BBE
!SAMUS_PROJ_RADIUS_Y = $0BC8
!SAMUS_BOMB_RADIUS_Y = $0BD2
!SAMUS_PROJ_X_VELOCITY = $0BDC
!SAMUS_BOMB_X_VELOCITY = $0BE6
!SAMUS_PROJ_Y_VELOCITY = $0BF0
!SAMUS_BOMB_Y_VELOCITY = $0BFA
!SAMUS_PROJ_DIRECTION = $0C04
!SAMUS_BOMB_DIRECTION = $0C0E
!SAMUS_PROJ_PROPERTIES = $0C18
!SAMUS_BOMB_PROPERTIES = $0C22
!SAMUS_PROJ_DAMAGE = $0C2C
!SAMUS_BOMB_DAMAGE = $0C36
!SAMUS_PROJ_INSTRUCTION_POINTER = $0C40
!SAMUS_BOMB_INSTRUCTION_POINTER = $0C4A
!SAMUS_PROJ_INSTRUCTION_TIMER = $0C54
!SAMUS_BOMB_INSTRUCTION_TIMER = $0C5E
!SAMUS_PROJ_PREINSTRUCTION = $0C68
!SAMUS_BOMB_PREINSTRUCTION = $0C72
!SAMUS_PROJ_VAR = $0C7C
!SAMUS_BOMB_TIMER = $0C86
!SAMUS_PROJ_TRAIL_TIMER = $0C90
!SAMUS_BOMB_SUBVELOCITY = $0C9A
!SAMUS_PROJ_PHASE = $0CA4
!SAMUS_BOMB_BOUNCE_Y_VELOCITY = $0CAE
!SAMUS_PROJ_SPRITEMAP = $0CB8
!SAMUS_BOMB_SPRITEMAP = $0CC2
!SAMUS_COOLDOWN = $0CCC
...
!SAMUS_SOLID_COLLISION_FLAG = $0DD0
!DEBUG_INVINCIBILITY = $0DE0
!DEBUG_CPU_BRIGHTNESS = $0DF4
...
!EARTHQUAKE_EXECUTION_COUNT = $1842
...
!ENEMY_PROJ_INIT_PARAMETER = $1993
!ENEMY_PROJ_ID = $1997
!ENEMY_PROJ_GFX_INDEX = $19BB
!ENEMY_PROJ_TIMER = $19DF
!ENEMY_PROJ_PREINSTRUCTION = $1A03
...
!ENEMY_PROJ_VAR_1 = $1AFF
!ENEMY_PROJ_VAR_2 = $1B23
!ENEMY_PROJ_INSTRUCTION_POINTER = $1B47
!ENEMY_PROJ_SPRITEMAP = $1B6B
!ENEMY_PROJ_INSTRUCTION_TIMER = $1B8F
!ENEMY_PROJ_RADIUS = $1BB3
!ENEMY_PROJ_PROPERTIES = $1BD7
!ENEMY_PROJ_TYPE = $1BFB
...
!eram_safeties_energy              = !ENEMY_ID
!eram_safeties_reserves            = !ENEMY_ID+$20
!eram_safeties_missiles            = !ENEMY_ID+$40
!eram_safeties_supers              = !ENEMY_ID+$60
!eram_safeties_pbs                 = !ENEMY_ID+$80
!eram_safeties_unequip_items       = !ENEMY_ID+$A0
!eram_safeties_unequip_beams       = !ENEMY_ID+$C0
!eram_safeties_enabled             = !ENEMY_ID+$E0
!eram_category_preset_stack        = !ENEMY_ID+$E2
...
!eram_apply_safeties_enable_flags  = !ENEMY_ID+$200
!eram_apply_safeties_combo_flag    = !ENEMY_ID+$220

; Mirrors the sram category adjustment variables
!eram_apply_adjust_item_equip      = !ENEMY_ID+$300
!eram_apply_adjust_item_unequip    = !ENEMY_ID+$302
!eram_apply_adjust_item_remove     = !ENEMY_ID+$304
!eram_apply_adjust_beam_equip      = !ENEMY_ID+$306
!eram_apply_adjust_beam_unequip    = !ENEMY_ID+$308
!eram_apply_adjust_beam_remove     = !ENEMY_ID+$30A
!eram_apply_adjust_energy          = !ENEMY_ID+$30C
!eram_apply_adjust_etanks          = !ENEMY_ID+$30E
!eram_apply_adjust_reserves        = !ENEMY_ID+$310
!eram_apply_adjust_rtanks          = !ENEMY_ID+$312
!eram_apply_adjust_missiles        = !ENEMY_ID+$314
!eram_apply_adjust_maxmissiles     = !ENEMY_ID+$316
!eram_apply_adjust_supers          = !ENEMY_ID+$318
!eram_apply_adjust_maxsupers       = !ENEMY_ID+$31A
!eram_apply_adjust_pbs             = !ENEMY_ID+$31C
!eram_apply_adjust_maxpbs          = !ENEMY_ID+$31E
!CATEGORY_ADJUST_SIZE_MINUS_ONE    = #((!ENEMY_ID+$31F)-(!eram_apply_adjust_item_equip))
...
!ROOM_LAYOUT_MAP_RANDO = #$0040
!ROOM_LAYOUT_ANY_RANDO = #$005E
...
!UPDATE_TIMERS_ALWAYS = #$0001
!UPDATE_TIMERS_ON_LANDED = #$0002
!UPDATE_TIMERS_ON_PRESS = #$0004
!UPDATE_TIMERS_ON_HOLD = #$0008
...
!SAFETIES_CMD_DONE    = $0D  ; End of safeties (0 bytes, can be omitted if all 16 safeties defined)
