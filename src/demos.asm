...
LoadDemoRoomData:
{
    ...
    CLC : ADC $12 : TAX
    LDA $910000,X : STA !ROOM_ID
    LDA $910002,X : STA !DOOR_ID
    ; Skip loading door slot
    LDA $910004,X : STA !LAYER1_X : STA !BG1_X_OFFSET
    LDA $910006,X : STA !LAYER1_Y : STA !BG1_Y_OFFSET
    LDA $910008,X : CLC : ADC !LAYER1_Y
    STA !SAMUS_Y : STA !SAMUS_PREVIOUS_Y
    LDA $91000A,X : CLC : ADC !LAYER1_X
    CLC : ADC #$0080 : STA !SAMUS_X : STA !SAMUS_PREVIOUS_X
    LDA $91000C,X : STA !DEMO_TIMER
...
; The other byte is used to convert LDA $0010,X to LDA $91000E,X
...
; One of these bytes is used to convert LDA.w DemoRoomData to LDA.l
; Another is used to convert LDA $0000,X to LDA $910000,X
...
DRC_LandingSite:
{
    ...
    LDA #$004A : STA !REG_2108_BG2_TILEMAP
    RTS
}
...
{
    dw $00A5, $0000 ; ............
    dw DemoInstruction_Goto, DemoInput_Shinespark
...
DemoInput_metroid3:
{
    ...
    dw $0002, $A180 ; ...Rs..B.A..
    dw $0004, $8180 ; ...R...B.A..
    dw $0001, $A1A0 ; ...Rs..B.Al.
    dw $0003, $A120 ; ...Rs..B..l.
    dw $0008, $8160 ; ...R...BX.l.
    dw $0003, $C140 ; ...R..YBX...
    dw $000E, $8100 ; ...R...B....
    dw $0005, $81C0 ; ...R...BXA..
    dw $0002, $8580 ; .D.R...B.A..
    dw $0002, $8480 ; .D.....B.A..
    dw $0004, $8080 ; .......B.A..
    dw $0003, $8580 ; .D.R...B.A..
    dw $0006, $8100 ; ...R...B....
    dw $000C, $8180 ; ...R...B.A..
    dw $000E, $0100 ; ...R........
    dw DemoInstruction_Delete
