                ...
                <div>
                    ...
                    <Card>
                        ...
                        <CardBody>
                            ...
                            <Row>
                                <Col md="4">Game</Col>
                                <Col>Toggle game options</Col>
                            </Row>
                            <Row>
                                <Col md="3" className="offset-md-1">Japanese Text</Col>
                                <Col>Standard game option to toggle between English and Japanese text.</Col>
                            </Row>
                            <Row>
                                <Col md="3" className="offset-md-1">Moon Walk</Col>
                                <Col>Standard game option for Moon Walk.</Col>
                            </Row>
                            <Row>
                                <Col md="3" className="offset-md-1">Icon Cancel</Col>
                                <Col>Standard game option for Icon Cancel.</Col>
                            </Row>
                            <Row>
                                <Col md="3" className="offset-md-1">Debug Mode</Col>
                                <Col>Toggles the debug mode. Note that debug mode shortcuts and features may not be well supported in the practice rom.</Col>
                            </Row>
                            <Row>
                                <Col md="3" className="offset-md-1">Debug CPU Brightness</Col>
                                <Col>Toggles a built-in debug feature to darken the screen after the game is done processing the next frame.
                                     Useful for estimating CPU usage.</Col>
                            </Row>
                            <Row>
                                <Col md="3" className="offset-md-1">Minimap</Col>
                                <Col>Restores the game minimap, which also allows the pause menu map to be updated.
                                     When enabled, a map tile counter will also be displayed.</Col>
                            </Row>
                            <Row>
                            ...
                            <Row>
                                ...
                                <Col>Toggles rerandomizing of RNG values upon loading a savestate. SD2SNES/FXPak versions only.</Col>
                            </Row>
                            <Row>
                            ...
                            <Row>
                                <Col md="3" className="offset-md-1">Kraid Claw RNG</Col>
                                <Col>Set Kraid's claws to spawn above or below. Kraid is laggier when coming out of the ground if both claws spawn below.
                                     Note: It is not possible for both claws to spawn above Kraid, so there will always be some lag generated by a claw below.</Col>
                            </Row>
                            <br />
                            <Row>
