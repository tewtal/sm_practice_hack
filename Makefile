...
smhack14low:
	cp resources/sm_orig.sfc build/smhack20_14low.sfc && cd src && asar --no-title-check -DFEATURE_SD2SNES=0 -DCATEGORY=4 main.asm ../build/smhack20_14low.sfc && cd -

smhackallboss:
	cp resources/sm_orig.sfc build/smhack20_allboss.sfc && cd src && asar --no-title-check -DFEATURE_SD2SNES=0 -DCATEGORY=5 main.asm ../build/smhack20_allboss.sfc && cd -
...
sd2snes14low:
	cp resources/sm_orig.sfc build/smhack20_sd2snes_14low.sfc && cd src && asar --no-title-check -DFEATURE_SD2SNES=1 -DCATEGORY=4 main.asm ../build/smhack20_sd2snes_14low.sfc && cd -

sd2snesallboss:
	cp resources/sm_orig.sfc build/smhack20_sd2snes_allboss.sfc && cd src && asar --no-title-check -DFEATURE_SD2SNES=1 -DCATEGORY=5 main.asm ../build/smhack20_sd2snes_allboss.sfc && cd -

all: sd2snes smhack sd2snesrbo smhackrbo sd2sneskpdr25 smhackkpdr25 sd2snesgtclassic smhackgtclassic sd2snes14low smhack14low sd2snesallboss smhackallboss
